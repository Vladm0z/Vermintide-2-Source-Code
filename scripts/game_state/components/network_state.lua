...
NetworkState.init = function (arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
...
NetworkState.register_callback = function (arg_2_0, arg_2_1, arg_2_2, arg_2_3, ...)
	arg_2_0._shared_state:register_callback(arg_2_1, arg_2_2, arg_2_3, ...)
end

NetworkState.unregister_callback = function (arg_3_0, arg_3_1, arg_3_2)
	arg_3_0._shared_state:unregister_callback(arg_3_1, arg_3_2)
end

NetworkState.full_sync = function (arg_4_0)
	arg_4_0._shared_state:full_sync()
end

NetworkState.register_rpcs = function (arg_5_0, arg_5_1, arg_5_2)
	arg_5_0._shared_state:register_rpcs(arg_5_1)
end

NetworkState.unregister_network_events = function (arg_6_0)
	arg_6_0._shared_state:unregister_rpcs()
end

NetworkState.destroy = function (arg_7_0)
	arg_7_0._shared_state:destroy()

	arg_7_0._shared_state = nil
end

NetworkState.get_revision = function (arg_8_0)
	return arg_8_0._shared_state:get_revision()
end

NetworkState.is_peer_fully_synced = function (arg_9_0, arg_9_1)
	return arg_9_0._shared_state:is_peer_fully_synced(arg_9_1)
end

NetworkState.is_fully_synced = function (arg_10_0)
	return arg_10_0:is_peer_fully_synced(arg_10_0._own_peer_id)
end

NetworkState.is_server = function (arg_11_0)
	return arg_11_0._is_server
end

NetworkState.get_server_peer_id = function (arg_12_0)
	return arg_12_0._server_peer_id
end

NetworkState.get_own_peer_id = function (arg_13_0)
	return arg_13_0._own_peer_id
end

NetworkState.get_peers = function (arg_14_0)
	local var_14_0 = arg_14_0._shared_state:get_key("peers")

	return arg_14_0._shared_state:get_server(var_14_0)
end

NetworkState.add_peer = function (arg_15_0, arg_15_1)
...
NetworkState.remove_peer = function (arg_16_0, arg_16_1)
...
NetworkState.get_peer_initialized = function (arg_17_0, arg_17_1)
	local var_17_0 = arg_17_0._shared_state:get_key("peer_initialized", arg_17_1)

	return arg_17_0._shared_state:get_server(var_17_0)
end

NetworkState.set_peer_initialized = function (arg_18_0, arg_18_1, arg_18_2)
...
NetworkState.set_peer_hot_join_synced = function (arg_35_0, arg_35_1, arg_35_2)
...
NetworkState.get_loaded_or_loading_packages = function (arg_36_0)
	return arg_36_0._loaded_or_loading_packages
end

NetworkState.set_loaded_or_loading_packages = function (arg_37_0, arg_37_1)
	arg_37_0._loaded_or_loading_packages = arg_37_1
end

NetworkState.loaded_or_loading_package_peers = function (arg_38_0)
	return arg_38_0._loaded_or_loading_package_peers
end

NetworkState.set_loaded_or_loading_package_peers = function (arg_39_0, arg_39_1)
	arg_39_0._loaded_or_loading_package_peers = arg_39_1
end

NetworkState.get_profile_index_reservation = function (arg_40_0, arg_40_1, arg_40_2)
...
NetworkState.set_profile_index_reservation = function (arg_41_0, arg_41_1, arg_41_2, arg_41_3, arg_41_4)
...
NetworkState.clear_persistent_profile_index_reservation = function (arg_42_0, arg_42_1)
...
NetworkState.set_bot_profile = function (arg_43_0, arg_43_1, arg_43_2, arg_43_3, arg_43_4)
...
NetworkState.get_bot_profile = function (arg_44_0, arg_44_1, arg_44_2)
...
NetworkState.get_persistent_profile_index_reservation = function (arg_45_0, arg_45_1)
...
NetworkState.get_peers_with_full_profiles = function (arg_46_0)
	local var_46_0 = arg_46_0._shared_state:get_key("full_profile_peers")

	return arg_46_0._shared_state:get_server(var_46_0)
end

NetworkState.get_profile = function (arg_47_0, arg_47_1, arg_47_2)
...
NetworkState.set_profile = function (arg_48_0, arg_48_1, arg_48_2, arg_48_3, arg_48_4, arg_48_5)
...
NetworkState.get_inventory_data = function (arg_49_0, arg_49_1, arg_49_2)
...
NetworkState.set_inventory_data = function (arg_50_0, arg_50_1, arg_50_2, arg_50_3)
...
NetworkState.get_loaded_inventory_id = function (arg_51_0, arg_51_1, arg_51_2, arg_51_3)
...
NetworkState.set_own_loaded_inventory_id = function (arg_52_0, arg_52_1, arg_52_2, arg_52_3)
...
NetworkState.delete_profile_data = function (arg_53_0, arg_53_1, arg_53_2)
...
NetworkState.get_actually_ingame = function (arg_54_0, arg_54_1)
...
NetworkState.set_own_actually_ingame = function (arg_55_0, arg_55_1)
...
NetworkState.get_own_loaded_session_breed_map = function (arg_66_0)
	local var_66_0 = arg_66_0._shared_state:get_key("loaded_session_breed_map")

	return arg_66_0._shared_state:get_own(var_66_0)
end

NetworkState.set_own_loaded_session_breeds = function (arg_67_0, arg_67_1)
...
NetworkState.set_startup_breeds = function (arg_68_0, arg_68_1)
...
NetworkState.get_loaded_session_pickup_map = function (arg_74_0, arg_74_1)
