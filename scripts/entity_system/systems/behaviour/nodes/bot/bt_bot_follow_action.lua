...
BTBotFollowAction.init = function (arg_1_0, ...)
	BTBotFollowAction.super.init(arg_1_0, ...)
end

BTBotFollowAction.name = "BTBotFollowAction"

BTBotFollowAction.enter = function (arg_2_0, arg_2_1, arg_2_2, arg_2_3)
...
BTBotFollowAction.leave = function (arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5)
	arg_3_2.follow.goal_selection_func = nil
end

BTBotFollowAction.run = function (arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
