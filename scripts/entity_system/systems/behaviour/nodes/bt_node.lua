...
BTNode.init = function (arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4, arg_1_5, arg_1_6)
	...
	if arg_1_4 then
		...
		if var_1_1 then
			...
			arg_1_0.enter = function (arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	...
	if arg_1_5 then
		...
		if var_1_2 then
			...
			arg_1_0.leave = function (arg_3_0, arg_3_1, arg_3_2, arg_3_3)
...
BTNode.parent = function (arg_9_0)
	return arg_9_0._parent
end

BTNode.run = function (arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4)
	error(false, "Implement in inherited class: " .. arg_10_0:name())
end

BTNode.set_running_child = function (arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4, arg_11_5, arg_11_6)
...
BTNode.current_running_child = function (arg_12_0, arg_12_1)
