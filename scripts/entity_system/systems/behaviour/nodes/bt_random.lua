...
BTRandom.init = function (arg_1_0, ...)
	BTRandom.super.init(arg_1_0, ...)

	arg_1_0._children = {}
end

BTRandom.ready = function (arg_2_0, arg_2_1)
	local var_2_0 = {}
