...
BTSelector_chaos_tentacle.init = function (arg_2_0, ...)
	BTSelector_chaos_tentacle.super.init(arg_2_0, ...)

	arg_2_0._children = {}
end

BTSelector_chaos_tentacle.leave = function (arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	arg_3_0:set_running_child(arg_3_1, arg_3_2, arg_3_3, nil, arg_3_4)
end

BTSelector_chaos_tentacle.run = function (arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
