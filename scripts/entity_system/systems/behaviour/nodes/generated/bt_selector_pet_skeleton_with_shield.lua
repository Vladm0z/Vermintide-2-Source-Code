-- chunkname: @scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_pet_skeleton_with_shield.lua
...
BTSelector_pet_skeleton_with_shield = class(BTSelector_pet_skeleton_with_shield, BTNode)
BTSelector_pet_skeleton_with_shield.name = "BTSelector_pet_skeleton_with_shield"

function BTSelector_pet_skeleton_with_shield.init(arg_2_0, ...)
	BTSelector_pet_skeleton_with_shield.super.init(arg_2_0, ...)

	arg_2_0._children = {}
end

function BTSelector_pet_skeleton_with_shield.leave(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	arg_3_0:set_running_child(arg_3_1, arg_3_2, arg_3_3, nil, arg_3_4)
end

function BTSelector_pet_skeleton_with_shield.run(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	if var_0_0(arg_4_2.target_unit) and arg_4_2.dist_to_commander and arg_4_2.target_dist + arg_4_2.dist_to_commander < arg_4_2.max_combat_range then
...
function BTSelector_pet_skeleton_with_shield.add_child(arg_5_0, arg_5_1)
