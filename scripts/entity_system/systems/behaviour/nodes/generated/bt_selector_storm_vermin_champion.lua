...
BTSelector_storm_vermin_champion.run = function (arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	local var_4_11
	local var_4_12 = arg_4_2.next_smart_object_data

	if not (var_4_12.next_smart_object_id ~= nil) then
		var_4_11 = false
	end

	local var_4_13 = arg_4_2.is_smart_objecting
	local var_4_14 = Managers.state.entity:system("nav_graph_system")
	local var_4_15 = var_4_12.smart_object_data and var_4_12.smart_object_data.unit
	local var_4_16, var_4_17 = var_4_14:has_nav_graph(var_4_15)

	if var_4_16 and not var_4_17 and not var_4_13 and var_4_11 == nil then
		var_4_11 = false
	end

	local var_4_18 = arg_4_2.is_in_smartobject_range
	local var_4_19 = arg_4_2.move_state == "moving"

	if var_4_11 == nil then
		var_4_11 = var_4_18 and var_4_19 or var_4_13
	end

	if var_4_11 then
		arg_4_0:set_running_child(arg_4_1, arg_4_2, arg_4_3, var_4_10, "aborted")

		local var_4_20, var_4_21 = var_4_10:run(arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	if var_4_23 then
		...
		local var_4_24, var_4_25 = var_4_22:run(arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	elseif var_4_22 == var_4_2 then
		arg_4_0:set_running_child(arg_4_1, arg_4_2, arg_4_3, nil, "failed")
	end

	local var_4_26 = var_4_3[5]
	local var_4_27 = Managers.time:time("game")
	local var_4_28 = var_4_27 - arg_4_2.surrounding_players_last

	if arg_4_2.defensive_mode_duration and var_4_28 >= 3 then
		arg_4_0:set_running_child(arg_4_1, arg_4_2, var_4_27, var_4_26, "aborted")

		local var_4_29, var_4_30 = var_4_26:run(arg_4_1, arg_4_2, var_4_27, arg_4_4)

		if var_4_29 ~= "running" then
			arg_4_0:set_running_child(arg_4_1, arg_4_2, var_4_27, nil, var_4_29)
		end
	...
	elseif var_4_26 == var_4_2 then
		arg_4_0:set_running_child(arg_4_1, arg_4_2, var_4_27, nil, "failed")
	end

	local var_4_31 = var_4_3[6]
