-- chunkname: @scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_pet_skeleton_dual_wield.lua
...
BTSelector_pet_skeleton_dual_wield = class(BTSelector_pet_skeleton_dual_wield, BTNode)
BTSelector_pet_skeleton_dual_wield.name = "BTSelector_pet_skeleton_dual_wield"

BTSelector_pet_skeleton_dual_wield.init = function (arg_2_0, ...)
	BTSelector_pet_skeleton_dual_wield.super.init(arg_2_0, ...)

	arg_2_0._children = {}
end

BTSelector_pet_skeleton_dual_wield.leave = function (arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	arg_3_0:set_running_child(arg_3_1, arg_3_2, arg_3_3, nil, arg_3_4)
end

BTSelector_pet_skeleton_dual_wield.run = function (arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
...
BTSelector_pet_skeleton_dual_wield.add_child = function (arg_5_0, arg_5_1)
