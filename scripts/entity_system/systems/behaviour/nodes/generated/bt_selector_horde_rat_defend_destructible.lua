-- chunkname: @scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_horde_rat_defend_destructible.lua
...
BTSelector_horde_rat_defend_destructible = class(BTSelector_horde_rat_defend_destructible, BTNode)
BTSelector_horde_rat_defend_destructible.name = "BTSelector_horde_rat_defend_destructible"

BTSelector_horde_rat_defend_destructible.init = function (arg_2_0, ...)
	BTSelector_horde_rat_defend_destructible.super.init(arg_2_0, ...)

	arg_2_0._children = {}
end

BTSelector_horde_rat_defend_destructible.leave = function (arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	arg_3_0:set_running_child(arg_3_1, arg_3_2, arg_3_3, nil, arg_3_4)
end

BTSelector_horde_rat_defend_destructible.run = function (arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
...
BTSelector_horde_rat_defend_destructible.add_child = function (arg_5_0, arg_5_1)
