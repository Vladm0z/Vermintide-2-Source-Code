-- chunkname: @scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_chaos_tether_sorcerer.lua
...
BTSelector_chaos_tether_sorcerer = class(BTSelector_chaos_tether_sorcerer, BTNode)
BTSelector_chaos_tether_sorcerer.name = "BTSelector_chaos_tether_sorcerer"

function BTSelector_chaos_tether_sorcerer.init(arg_2_0, ...)
	BTSelector_chaos_tether_sorcerer.super.init(arg_2_0, ...)

	arg_2_0._children = {}
end

function BTSelector_chaos_tether_sorcerer.leave(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	arg_3_0:set_running_child(arg_3_1, arg_3_2, arg_3_3, nil, arg_3_4)
end

function BTSelector_chaos_tether_sorcerer.run(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
...
function BTSelector_chaos_tether_sorcerer.add_child(arg_5_0, arg_5_1)
