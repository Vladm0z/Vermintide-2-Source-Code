-- chunkname: @scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_chaos_exalted_champion_norsca.lua
...
function BTSelector_chaos_exalted_champion_norsca.init(arg_2_0, ...)
	BTSelector_chaos_exalted_champion_norsca.super.init(arg_2_0, ...)

	arg_2_0._children = {}
end

function BTSelector_chaos_exalted_champion_norsca.leave(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	arg_3_0:set_running_child(arg_3_1, arg_3_2, arg_3_3, nil, arg_3_4)
end

function BTSelector_chaos_exalted_champion_norsca.run(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	if arg_4_2.current_phase == 2 then
	...
	local var_4_14
	local var_4_15 = arg_4_2.next_smart_object_data

	if not (var_4_15.next_smart_object_id ~= nil) then
		var_4_14 = false
	end

	local var_4_16 = arg_4_2.is_smart_objecting
	local var_4_17 = Managers.state.entity:system("nav_graph_system")
	local var_4_18 = var_4_15.smart_object_data and var_4_15.smart_object_data.unit
	local var_4_19, var_4_20 = var_4_17:has_nav_graph(var_4_18)

	if var_4_19 and not var_4_20 and not var_4_16 and var_4_14 == nil then
		var_4_14 = false
	end

	local var_4_21 = arg_4_2.is_in_smartobject_range
	local var_4_22 = arg_4_2.move_state == "moving"

	if var_4_14 == nil then
		var_4_14 = var_4_21 and var_4_22 or var_4_16
	end

	if var_4_14 then
		arg_4_0:set_running_child(arg_4_1, arg_4_2, arg_4_3, var_4_13, "aborted")

		local var_4_23, var_4_24 = var_4_13:run(arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	if var_4_26 then
		arg_4_0:set_running_child(arg_4_1, arg_4_2, arg_4_3, var_4_25, "aborted")

		local var_4_27, var_4_28 = var_4_25:run(arg_4_1, arg_4_2, arg_4_3, arg_4_4)
...
function BTSelector_chaos_exalted_champion_norsca.add_child(arg_5_0, arg_5_1)
