-- chunkname: @scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_explosive_loot_rat.lua
...
function BTSelector_explosive_loot_rat.init(arg_2_0, ...)
	BTSelector_explosive_loot_rat.super.init(arg_2_0, ...)

	arg_2_0._children = {}
end

function BTSelector_explosive_loot_rat.leave(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	arg_3_0:set_running_child(arg_3_1, arg_3_2, arg_3_3, nil, arg_3_4)
end

function BTSelector_explosive_loot_rat.run(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
...
function BTSelector_explosive_loot_rat.add_child(arg_5_0, arg_5_1)
