...
function BTSelector_standard_bearer.init(arg_2_0, ...)
	BTSelector_standard_bearer.super.init(arg_2_0, ...)

	arg_2_0._children = {}
end

function BTSelector_standard_bearer.leave(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	arg_3_0:set_running_child(arg_3_1, arg_3_2, arg_3_3, nil, arg_3_4)
end

function BTSelector_standard_bearer.run(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
...
function BTSelector_standard_bearer.add_child(arg_5_0, arg_5_1)
