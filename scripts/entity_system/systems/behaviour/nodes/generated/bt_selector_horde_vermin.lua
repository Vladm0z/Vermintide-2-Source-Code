-- chunkname: @scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_horde_vermin.lua
...
BTSelector_horde_vermin.init = function (arg_2_0, ...)
	BTSelector_horde_vermin.super.init(arg_2_0, ...)

	arg_2_0._children = {}
end

BTSelector_horde_vermin.leave = function (arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	arg_3_0:set_running_child(arg_3_1, arg_3_2, arg_3_3, nil, arg_3_4)
end

BTSelector_horde_vermin.run = function (arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	local var_4_33 = arg_4_2.target_unit
	local var_4_34 = not ScriptUnit.has_extension(var_4_33, "locomotion_system")

	if var_0_0(var_4_33) and arg_4_2.confirmed_player_sighting and var_4_34 then
...
BTSelector_horde_vermin.add_child = function (arg_5_0, arg_5_1)
