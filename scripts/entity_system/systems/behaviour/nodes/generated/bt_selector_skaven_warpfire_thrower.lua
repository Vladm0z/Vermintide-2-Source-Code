-- chunkname: @scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_skaven_warpfire_thrower.lua
...
function BTSelector_skaven_warpfire_thrower.init(arg_2_0, ...)
	BTSelector_skaven_warpfire_thrower.super.init(arg_2_0, ...)

	arg_2_0._children = {}
end

function BTSelector_skaven_warpfire_thrower.leave(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	arg_3_0:set_running_child(arg_3_1, arg_3_2, arg_3_3, nil, arg_3_4)
end

function BTSelector_skaven_warpfire_thrower.run(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	local var_4_33 = Managers.time:time("game")

	if var_4_33 > (arg_4_2.trigger_time or 0) and var_0_0(arg_4_2.target_unit) then
		arg_4_0:set_running_child(arg_4_1, arg_4_2, var_4_33, var_4_32, "aborted")

		local var_4_34, var_4_35 = var_4_32:run(arg_4_1, arg_4_2, var_4_33, arg_4_4)

		if var_4_34 ~= "running" then
			arg_4_0:set_running_child(arg_4_1, arg_4_2, var_4_33, nil, var_4_34)
		end
	...
	elseif var_4_32 == var_4_2 then
		arg_4_0:set_running_child(arg_4_1, arg_4_2, var_4_33, nil, "failed")
	end
...
function BTSelector_skaven_warpfire_thrower.add_child(arg_5_0, arg_5_1)
