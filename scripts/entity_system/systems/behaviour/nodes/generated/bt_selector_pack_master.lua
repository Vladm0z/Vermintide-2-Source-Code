...
function BTSelector_pack_master.run(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	if arg_4_2.escorting_rat_ogre then
	...
	local var_4_39 = Managers.time:time("game")

	if var_4_39 > (arg_4_2.trigger_time or 0) and var_0_0(arg_4_2.target_unit) then
		arg_4_0:set_running_child(arg_4_1, arg_4_2, var_4_39, var_4_38, "aborted")

		local var_4_40, var_4_41 = var_4_38:run(arg_4_1, arg_4_2, var_4_39, arg_4_4)

		if var_4_40 ~= "running" then
			arg_4_0:set_running_child(arg_4_1, arg_4_2, var_4_39, nil, var_4_40)
		end
	...
	elseif var_4_38 == var_4_2 then
		arg_4_0:set_running_child(arg_4_1, arg_4_2, var_4_39, nil, "failed")
	end
