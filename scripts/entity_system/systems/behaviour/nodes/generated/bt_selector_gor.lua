...
function BTSelector_gor.init(arg_2_0, ...)
	BTSelector_gor.super.init(arg_2_0, ...)

	arg_2_0._children = {}
end

function BTSelector_gor.leave(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	arg_3_0:set_running_child(arg_3_1, arg_3_2, arg_3_3, nil, arg_3_4)
end

function BTSelector_gor.run(arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	local var_4_36 = var_0_0(arg_4_2.target_unit) and arg_4_2.is_alerted and (not arg_4_2.confirmed_player_sighting or arg_4_2.hesitating)
	local var_4_37 = var_0_0(arg_4_2.taunt_unit) and not arg_4_2.taunt_hesitate_finished and not arg_4_2.no_taunt_hesitate

	if var_4_36 or var_4_37 then
		arg_4_0:set_running_child(arg_4_1, arg_4_2, arg_4_3, var_4_35, "aborted")

		local var_4_38, var_4_39 = var_4_35:run(arg_4_1, arg_4_2, arg_4_3, arg_4_4)
...
function BTSelector_gor.add_child(arg_5_0, arg_5_1)
