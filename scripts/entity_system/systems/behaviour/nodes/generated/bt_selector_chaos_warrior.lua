-- chunkname: @scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_chaos_warrior.lua
...
BTSelector_chaos_warrior = class(BTSelector_chaos_warrior, BTNode)
BTSelector_chaos_warrior.name = "BTSelector_chaos_warrior"

BTSelector_chaos_warrior.init = function (arg_2_0, ...)
	BTSelector_chaos_warrior.super.init(arg_2_0, ...)

	arg_2_0._children = {}
end

BTSelector_chaos_warrior.leave = function (arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	arg_3_0:set_running_child(arg_3_1, arg_3_2, arg_3_3, nil, arg_3_4)
end

BTSelector_chaos_warrior.run = function (arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
...
BTSelector_chaos_warrior.add_child = function (arg_5_0, arg_5_1)
