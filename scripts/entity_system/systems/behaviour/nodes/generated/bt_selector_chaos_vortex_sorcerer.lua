-- chunkname: @scripts/entity_system/systems/behaviour/nodes/generated/bt_selector_chaos_vortex_sorcerer.lua
...
BTSelector_chaos_vortex_sorcerer.init = function (arg_2_0, ...)
	BTSelector_chaos_vortex_sorcerer.super.init(arg_2_0, ...)

	arg_2_0._children = {}
end

BTSelector_chaos_vortex_sorcerer.leave = function (arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	arg_3_0:set_running_child(arg_3_1, arg_3_2, arg_3_3, nil, arg_3_4)
end

BTSelector_chaos_vortex_sorcerer.run = function (arg_4_0, arg_4_1, arg_4_2, arg_4_3, arg_4_4)
	...
	if arg_4_2.ready_to_summon and (arg_4_2.summoning or Unit.alive(arg_4_2.target_unit)) then
...
BTSelector_chaos_vortex_sorcerer.add_child = function (arg_5_0, arg_5_1)
