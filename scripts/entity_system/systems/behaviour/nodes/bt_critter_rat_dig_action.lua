...
function BTCritterRatDigAction.init(arg_1_0, ...)
	BTCritterRatDigAction.super.init(arg_1_0, ...)
end

BTCritterRatDigAction.name = "BTCritterRatDigAction"

function BTCritterRatDigAction.enter(arg_2_0, arg_2_1, arg_2_2, arg_2_3)
	arg_2_2.navigation_extension:set_enabled(false)
	arg_2_2.locomotion_extension:set_wanted_velocity(Vector3.zero())
	Managers.state.network:anim_event(arg_2_1, "dig_ground")
end

function BTCritterRatDigAction.leave(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4, arg_3_5)
...
function BTCritterRatDigAction.run(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
