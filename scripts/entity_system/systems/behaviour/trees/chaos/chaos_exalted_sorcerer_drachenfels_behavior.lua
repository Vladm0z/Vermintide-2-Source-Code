...
local var_0_0 = BreedActions.chaos_exalted_sorcerer_drachenfels
		...
		"BTSelector",
		{
			"BTSelector",
			{
				"BTSequence",
				{
					...
					action_data = var_0_0.spawn_allies_devensive_intense
				},
			...
			},
			{
				...
				},
				{
					...
					action_data = var_0_0.teleport_to_float
				},
		...
		"BTSelector",
		{
			"BTSelector",
			{
				"BTSequence",
				{
					...
					action_data = var_0_0.teleport_to_death
				},
				{
					"BTChampionAttackAction",
					name = "death_explosion",
					leave_hook = "unclamp_health",
					action_data = var_0_0.death_explosion
				},
			...
			},
			{
				...
				{
					"BTSequence",
					action_data = var_0_0.ring_spawn,
					{
						"BTSpawnAllies",
						name = "spawn_allies_trickle",
						enter_hook = "trickle_spawn_drachenfels",
						action_data = var_0_0.spawn_allies_trickle
					},
					name = "ring_spawn",
				...
				},
				{
					...
					name = "swing_floating",
					action_data = var_0_0.swing_floating
				},
				{
					"BTMeleeOverlapAttackAction",
					name = "combo_attack",
		...
		},
		{
			...
			},
			{
				"BTSequence",
				{
					...
					action_data = var_0_0.teleport_to_aoe
				},
				{
					"BTChaosSorcererSummoningAction",
					name = "spawn_boss_rings_1",
					action_data = var_0_0.spawn_boss_rings_1
				},
				{
					"BTDefensiveIdleAction",
					name = "exhausted_idle",
					leave_hook = "ring_summoning_ends",
					action_data = var_0_0.exhausted_idle
				},
				name = "summon_rings",
			...
			},
			{
				...
				},
				{
					...
					},
					{
						...
						weight = 5,
						action_data = var_0_0.spawn_boss_rings_2
					},
					{
						"BTChaosSorcererSummoningAction",
						name = "spawn_boss_rings_3",
						weight = 5,
						action_data = var_0_0.spawn_boss_rings_3
					},
					{
						"BTChaosSorcererSummoningAction",
						name = "spawn_boss_rings_5",
						weight = 5,
						action_data = var_0_0.spawn_boss_rings_5
					},
			...
			},
			{
				"BTUtilityNode",
				{
					...
					action_data = var_0_0.retaliation_aoe
				},
				{
					"BTStormVerminAttackAction",
					name = "overhead_downed",
					condition = "ask_target_before_attacking",
					action_data = var_0_0.overhead_downed
				},
				{
					"BTStormVerminAttackAction",
					name = "cleave_downed",
					condition = "ask_target_before_attacking",
					action_data = var_0_0.cleave_downed
				},
				{
					"BTSequence",
					action_data = var_0_0.spawn_trickle,
					{
						"BTQuickTeleportAction",
					...
					},
					{
						...
						action_data = var_0_0.spawn_allies_offensive
					},
					name = "spawn_trickle"
				},
				{
