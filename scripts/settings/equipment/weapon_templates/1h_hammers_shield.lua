-- chunkname: @scripts/settings/equipment/weapon_templates/1h_hammers_shield.lua
...
var_0_2.wield_anim = "to_1h_hammer_shield"
var_0_2.state_machine = "units/beings/player/first_person_base/state_machines/melee/1h_hammer_shield"
var_0_2.buff_type = "MELEE_1H"
var_0_2.weapon_type = "MACE_1H_SHIELD"
var_0_2.shield_block = true
var_0_2.max_fatigue_points = 10
var_0_2.dodge_count = 2
...
var_0_4.actions.action_one.light_attack_left.range_mod = 1
var_0_4.actions.action_one.light_attack_right.range_mod = 1
var_0_4.actions.action_one.light_attack_last.range_mod = 1

local var_0_5 = table.clone(ActionTemplates.action_inspect)

var_0_5.action_inspect_hold.anim_event = "inspect_start_2"
var_0_4.actions.action_inspect = var_0_5

return {
	one_handed_hammer_shield_template_1 = var_0_3,
	one_handed_hammer_shield_template_2 = var_0_4
}
