	...
	actions = {
		action_one = {
			...
			heavy_attack = {
				...
				damage_profile_left = "light_slashing_smiter_stab_dual_dagger",
				attack_direction = "up",
				...
				damage_profile_right = "light_slashing_smiter_stab_dual_dagger",
...
var_0_2.display_unit = "units/weapons/weapon_display/display_dual_daggers"
var_0_2.buff_type = "MELEE_1H"
var_0_2.weapon_type = "DUAL_DAGGER_1H"
var_0_2.max_fatigue_points = 4
var_0_2.dodge_count = 6
var_0_2.block_angle = 40
...
var_0_2.wield_anim = "to_dual_daggers"
var_0_2.state_machine = "units/beings/player/first_person_base/state_machines/melee/dual_daggers"
...
return {
	dual_wield_daggers_template_1 = table.clone(var_0_2)
}
