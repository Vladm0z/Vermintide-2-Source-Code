	...
	actions = {
		action_one = {
			...
			heavy_attack = {
				...
				anim_end_event = "attack_finished",
				damage_profile_right = "axe_falcion_heavy_smiter_vertical_right",
			...
			light_attack_right = {
				...
				use_precision_sweep = false,
				additional_critical_strike_chance = 0,
				damage_profile = "axe_falchion_light_smiter_horizontal",
				hit_effect = "melee_hit_sword_1h",
...
var_0_2.display_unit = "units/weapons/weapon_display/dual_wield_axe_falchion"
...
var_0_2.wield_anim = "to_dual_axe_sword_wh"
var_0_2.state_machine = "units/beings/player/first_person_base/state_machines/melee/dual_axe_sword_wh"
...
return {
	dual_wield_axe_falchion_template = var_0_2
}
