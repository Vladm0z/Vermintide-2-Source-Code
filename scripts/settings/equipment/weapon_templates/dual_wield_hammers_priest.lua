-- chunkname: @scripts/settings/equipment/weapon_templates/dual_wield_hammers_priest.lua
...
var_0_2.display_unit = "units/weapons/weapon_display/display_dual_hammers"
...
var_0_2.wield_anim = "to_dual_hammers_priest"
var_0_2.wield_anim_career = {
	wh_zealot = "to_dual_hammers",
	wh_priest = "to_dual_hammers_priest",
	wh_captain = "to_dual_hammers",
	wh_bountyhunter = "to_dual_hammers"
}
var_0_2.state_machine = "units/beings/player/first_person_base/state_machines/melee/dual_hammers_priest"
var_0_2.state_machine_career = {
...
return {
	dual_wield_hammers_priest_template = var_0_2
}
