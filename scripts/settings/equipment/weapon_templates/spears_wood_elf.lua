...
var_0_2.wield_anim = "to_spear"
var_0_2.state_machine = "units/beings/player/first_person_base/state_machines/melee/spear"
...
return {
	two_handed_spears_elf_template_1 = table.clone(var_0_2)
}
