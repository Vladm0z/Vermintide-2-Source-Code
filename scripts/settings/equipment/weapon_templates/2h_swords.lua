-- chunkname: @scripts/settings/equipment/weapon_templates/2h_swords.lua
	...
	actions = {
		action_one = {
			...
			light_attack_left = {
				...
				use_precision_sweep = false,
				hit_effect = "melee_hit_sword_2h",
				damage_profile = "medium_slashing_linesman_2h",
...
return {
	two_handed_swords_template_1 = table.clone(var_0_2)
}
