-- chunkname: @scripts/settings/equipment/weapon_templates/1h_axes_shield.lua
	...
	actions = {
		action_one = {
			...
			heavy_attack_left = {
				...
				damage_profile = "axe_shield_heavy_smiter_vertical",
			...
			light_attack_left = {
				...
				damage_profile = "axe_shield_light_smiter_diag",
			...
			light_attack_last = {
				...
				no_damage_impact_sound_event = "blunt_hit_armour",
				use_precision_sweep = true,
				damage_profile = "axe_shield_light_smiter_vertical",
				hit_shield_stop_anim = "attack_hit_shield",
				hit_effect = "melee_hit_axes_1h",
				damage_window_end = 0.5,
				impact_sound_event = "axe_1h_hit",
...
var_0_2.display_unit = "units/weapons/weapon_display/display_shield"
var_0_2.wield_anim = "to_1h_axe_shield"
var_0_2.state_machine = "units/beings/player/first_person_base/state_machines/melee/1h_axe_shield"
var_0_2.buff_type = "MELEE_1H"
var_0_2.weapon_type = "AXE_1H_SHIELD"
...
return {
	one_hand_axe_shield_template_1 = var_0_2
}
