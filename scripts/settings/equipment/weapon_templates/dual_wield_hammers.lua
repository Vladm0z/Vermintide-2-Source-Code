...
var_0_2.wield_anim = "to_dual_hammers"
var_0_2.state_machine = "units/beings/player/first_person_base/state_machines/melee/dual_hammers"
...
return {
	dual_wield_hammers_template = var_0_2
}
