-- chunkname: @scripts/settings/equipment/weapon_templates/bastard_swords.lua
...
var_0_2.display_unit = "units/weapons/weapon_display/display_2h_swords"
var_0_2.wield_anim = "to_bastard_sword"
var_0_2.state_machine = "units/beings/player/first_person_base/state_machines/melee/bastard_sword"
...
return {
	bastard_sword_template = var_0_2,
	bastard_sword_template_vs = table.clone(var_0_3)
}
