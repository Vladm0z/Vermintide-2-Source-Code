-- chunkname: @scripts/settings/equipment/weapon_templates/dual_wield_sword_dagger.lua
...
var_0_2.wield_anim = "to_dual_sword_dagger"
var_0_2.state_machine = "units/beings/player/first_person_base/state_machines/melee/dual_sword_dagger"
...
return {
	dual_wield_sword_dagger_template_1 = table.clone(var_0_2)
}
