-- chunkname: @scripts/settings/equipment/weapon_skins_anvil.lua

local var_0_0 = {
	{
		name = "bw_1h_flail_flaming_skin_01",
		data = {
	...
	{
		name = "bw_1h_flail_flaming_skin_01_runed_01",
		data = {
	...
	{
		name = "bw_1h_flail_flaming_skin_02",
		data = {
	...
	{
		name = "dr_1h_throwing_axes_skin_01",
		data = {
	...
	{
		name = "dr_1h_throwing_axes_skin_01_runed_01",
		data = {
			description = "dr_1h_throwing_axes_skin_01_runed_01_description",
			ammo_unit = "units/weapons/player/wpn_dw_thrown_axe_01_t1/wpn_dw_thrown_axe_01_t1_runed_01",
			link_pickup_template_name = "link_ammo_throwing_axe_01_t1_runed_01",
			is_ammo_weapon = true,
			inventory_icon = "icon_dw_thrown_axe_01_t1_runed_01",
			hud_icon = "weapon_generic_icon_falken",
			pickup_template_name = "ammo_throwing_axe_01_t1_runed_01",
			rarity = "promo",
	...
	{
		name = "dr_1h_throwing_axes_skin_02",
		data = {
			description = "dr_1h_throwing_axes_skin_02_description",
			ammo_unit = "units/weapons/player/wpn_dw_thrown_axe_01_t2/wpn_dw_thrown_axe_01_t2",
			link_pickup_template_name = "link_ammo_throwing_axe_01_t2",
			is_ammo_weapon = true,
			inventory_icon = "icon_dw_thrown_axe_01_t2",
			hud_icon = "weapon_generic_icon_falken",
			pickup_template_name = "ammo_throwing_axe_01_t2",
			rarity = "promo",
			display_name = "dr_1h_throwing_axes_skin_02_name",
			right_hand_unit = "units/weapons/player/wpn_invisible_weapon",
			template = "one_handed_throwing_axes_template",
			display_unit = "units/weapons/weapon_display/display_1h_throwing_axes",
			projectile_units_template = "throwing_axe_01_t2"
		}
	},
	{
		name = "es_2h_heavy_spear_skin_01",
		data = {
	...
	{
		name = "es_2h_heavy_spear_skin_01_runed_01",
		data = {
	...
	{
		name = "es_2h_heavy_spear_skin_02",
		data = {
	...
	{
		name = "we_1h_spears_shield_skin_01",
		data = {
	...
	{
		name = "we_1h_spears_shield_skin_02",
		data = {
	...
	{
		name = "wh_2h_billhook_skin_01_runed_01",
		data = {
