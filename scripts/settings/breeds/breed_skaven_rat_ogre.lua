...
Breeds.skaven_rat_ogre = table.create_copy(Breeds.skaven_rat_ogre, var_0_2)
...
BreedActions.skaven_rat_ogre = table.create_copy(BreedActions.skaven_rat_ogre, var_0_5)
