...
Breeds.pet_skeleton_with_shield = table.create_copy(Breeds.pet_skeleton_with_shield, var_0_1)
...
local var_0_3 = {
	...
	ability_shield_bash = {
		...
		ignore_staggers = {
			...
			[var_0_0.medium] = true,
			[var_0_0.heavy] = true,
			[var_0_0.ranged_weak] = true,
			[var_0_0.ranged_medium] = true,
			[var_0_0.explosion] = false,
			[var_0_0.weakspot] = true,
			[var_0_0.pulling] = true
		},
...
BreedActions.pet_skeleton_with_shield = table.create_copy(BreedActions.pet_skeleton_with_shield, var_0_3)
