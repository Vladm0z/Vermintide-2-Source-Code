-- chunkname: @scripts/settings/hit_effects/hit_effects_chaos_sorcerer.lua
...
HitEffectsChaosSorcerer = table.create_copy(HitEffectsChaosSorcerer, HitEffectsChaosSorcerer)
