-- chunkname: @scripts/settings/hit_effects/hit_effects_chaos_bulwark.lua
...
HitEffectsChaosBulwark = table.create_copy(HitEffectsChaosBulwark, HitEffectsChaosBulwark)
