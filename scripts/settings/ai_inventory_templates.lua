-- chunkname: @scripts/settings/ai_inventory_templates.lua
...
InventoryConfigurations.skaven_clan_rat_sword = {
...
InventoryConfigurations.marauder_mace = {
	enemy_hit_sound = "sword",
	anim_state_event = "to_sword",
	items = {
...
InventoryConfigurations.opt_beastmen_ungor_archer_bow_and_spear = {
	enemy_hit_sound = "spear",
	multiple_configurations = {
...
InventoryConfigurations.beastmen_gor_1h = {
	enemy_hit_sound = "sword",
	anim_state_event = "to_sword",
	items = {
		var_0_1.beastmen_1h,
...
InventoryConfigurations.warrior_axe_blk_shadow_lieutenant = {
	enemy_hit_sound = "spear",
	anim_state_event = "to_spear",
	items = {
