...
var_0_0.network_sound_events = {
	...
	"boon_static_blade",
	"boon_cluster_barrel_explosion",
	"boon_bad_breath",
	"boon_homerun",
	"boon_orb_pickup",
	"boon_orb_static_charge",
	"Play_curse_shadow_skulls_spawn",
	"Play_wave_start_spawn_stinger",
	"Play_wave_start_spawn_stinger_small",
	"Play_normal_spawn_stinger",
