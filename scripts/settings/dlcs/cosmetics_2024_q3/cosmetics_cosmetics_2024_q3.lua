-- chunkname: @scripts/settings/dlcs/cosmetics_2024_q3/cosmetics_cosmetics_2024_q3.lua
...
return {
	skin_bw_scholar_1003 = {
		...
		first_person_attachment = {
			unit = "units/beings/player/bright_wizard_scholar_skin_03/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/bright_wizard_scholar_skin_03/third_person_base/chr_third_person_mesh",
	...
	skin_dr_slayer_1003 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/dwarf_ranger_slayer_skin_03/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/dwarf_ranger_slayer_skin_03/third_person_base/chr_third_person_mesh",
	...
	skin_es_mercenary_1003 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/empire_soldier_mercenary_skin_03/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/empire_soldier_mercenary_skin_03/third_person_base/chr_third_person_mesh",
	...
	skin_ww_thornsister_1001 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/way_watcher_thornsister_skin_01/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/way_watcher_thornsister_skin_01/third_person_base/chr_third_person_mesh",
	...
	skin_wh_bountyhunter_1003 = {
		...
		first_person_bot = "units/beings/player/first_person_base/chr_first_person_bot_base",
		equip_skin_event = "using_skin_03",
		third_person_bot = "units/beings/player/third_person_base/witch_hunter/chr_third_person_base",
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/witch_hunter_bounty_hunter_skin_03/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/witch_hunter_bounty_hunter_skin_03/third_person_base/chr_third_person_mesh",
