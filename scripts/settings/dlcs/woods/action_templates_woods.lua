-- chunkname: @scripts/settings/dlcs/woods/action_templates_woods.lua

ActionTemplates.action_career_we_thornsister = {
	default = {
		...
		condition_func = function (arg_1_0, arg_1_1)
			...
			return var_1_0:can_use_activated_ability() and var_1_1.action_name == "action_career_we_thornsister"
		end,
