-- chunkname: @scripts/settings/dlcs/lake/cosmetics_lake.lua
...
return {
	skin_es_questingknight = {
		...
		first_person_attachment = {
			unit = "units/beings/player/empire_soldier_breton/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/empire_soldier_breton/third_person_base/chr_third_person_mesh",
	...
	skin_es_questingknight_white = {
		...
		material_changes = {
			package_name = "units/beings/player/empire_soldier_breton/skins/white/chr_empire_soldier_breton_white",
			third_person = {
				mtr_outfit = "units/beings/player/empire_soldier_breton/skins/white/mtr_outfit_white_3p",
				mtr_outfit_ds = "units/beings/player/empire_soldier_breton/skins/white/mtr_outfit_ds_white_3p"
			},
			first_person = {
				mtr_outfit = "units/beings/player/empire_soldier_breton/skins/white/mtr_outfit_white_1p"
			}
		}
	}
}
