-- chunkname: @scripts/settings/dlcs/cosmetics_2023_q4/cosmetics_cosmetics_2023_q4.lua
...
return {
	skin_bw_scholar_1002 = {
		...
		first_person_attachment = {
			unit = "units/beings/player/bright_wizard_scholar_skin_02/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/bright_wizard_scholar_skin_02/third_person_base/chr_third_person_mesh",
	...
	skin_dr_slayer_1002 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/dwarf_ranger_slayer_skin_02/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/dwarf_ranger_slayer_skin_02/third_person_base/chr_third_person_mesh",
	...
	skin_es_mercenary_1002 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/empire_soldier_mercenary_skin_02/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/empire_soldier_mercenary_skin_02/third_person_base/chr_third_person_mesh",
	...
	skin_ww_waywatcher_1002 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/way_watcher_upgraded_skin_02/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/way_watcher_upgraded_skin_02/third_person_base/chr_third_person_mesh",
	...
	skin_wh_captain_1002 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/witch_hunter_captain_skin_02/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/witch_hunter_captain_skin_02/third_person_base/chr_third_person_mesh",
