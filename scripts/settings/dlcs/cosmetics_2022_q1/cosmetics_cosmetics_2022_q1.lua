-- chunkname: @scripts/settings/dlcs/cosmetics_2022_q1/cosmetics_cosmetics_2022_q1.lua
...
return {
	skin_bw_unchained_1001 = {
		...
		first_person_attachment = {
			unit = "units/beings/player/bright_wizard_unchained_skin_01/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/bright_wizard_unchained_skin_01/third_person_base/chr_third_person_mesh",
	...
	skin_dr_ranger_1001 = {
		...
		first_person_attachment = {
			unit = "units/beings/player/dwarf_ranger_upgraded_skin_01/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/dwarf_ranger_upgraded_skin_01/third_person_base/chr_third_person_mesh",
	...
	skin_es_knight_1001 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/empire_soldier_knight_skin_01/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/empire_soldier_knight_skin_01/third_person_base/chr_third_person_mesh",
	...
	skin_ww_waywatcher_1001 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/way_watcher_upgraded_skin_01/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/way_watcher_upgraded_skin_01/third_person_base/chr_third_person_mesh",
	...
	skin_wh_captain_1001 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/witch_hunter_captain_skin_01/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/witch_hunter_captain_skin_01/third_person_base/chr_third_person_mesh",
