...
var_0_0.inventory_package_list = {
	...
	"units/beings/player/way_watcher_upgraded/headpiece/ww_u_hat_14",
	"units/beings/player/bright_wizard_unchained_skin_01/first_person_base/chr_first_person_mesh",
	"units/beings/player/bright_wizard_unchained_skin_01/third_person_base/chr_third_person_mesh",
	"units/beings/player/dwarf_ranger_upgraded_skin_01/first_person_base/chr_first_person_mesh",
	"units/beings/player/dwarf_ranger_upgraded_skin_01/third_person_base/chr_third_person_mesh",
	"units/beings/player/empire_soldier_knight_skin_01/first_person_base/chr_first_person_mesh",
