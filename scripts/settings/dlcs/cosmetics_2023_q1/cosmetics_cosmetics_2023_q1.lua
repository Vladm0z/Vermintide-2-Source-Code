-- chunkname: @scripts/settings/dlcs/cosmetics_2023_q1/cosmetics_cosmetics_2023_q1.lua
...
return {
	skin_bw_adept_1002 = {
		...
		first_person_attachment = {
			unit = "units/beings/player/bright_wizard_adept_skin_02/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/bright_wizard_adept_skin_02/third_person_base/chr_third_person_mesh",
	...
	skin_dr_engineer_1001 = {
		...
		first_person_attachment = {
			unit = "units/beings/player/dwarf_ranger_engineer_skin_01/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/dwarf_ranger_engineer_skin_01/third_person_base/chr_third_person_mesh",
	...
	skin_es_questingknight_1001 = {
		...
		equip_hat_event = "using_skin_01",
		first_person_attachment = {
			unit = "units/beings/player/empire_soldier_breton_skin_01/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/empire_soldier_breton_skin_01/third_person_base/chr_third_person_mesh",
	...
	skin_wh_priest_1001 = {
		...
		equip_hat_event = "using_skin_01",
		first_person_attachment = {
			unit = "units/beings/player/witch_hunter_warrior_priest_skin_01/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/witch_hunter_warrior_priest_skin_01/third_person_base/chr_third_person_mesh",
	...
	skin_ww_maidenguard_1002 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/way_watcher_maiden_guard_skin_02/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/way_watcher_maiden_guard_skin_02/third_person_base/chr_third_person_mesh",
