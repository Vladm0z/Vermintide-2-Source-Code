...
DEUS_MAP_POPULATE_SETTINGS.journey_ruin = table.clone(var_0_1)
...
DEUS_MAP_POPULATE_SETTINGS.journey_cave = table.clone(var_0_1)
...
DEUS_MAP_POPULATE_SETTINGS.journey_ice = table.clone(var_0_1)
...
DEUS_MAP_POPULATE_SETTINGS.journey_citadel = table.clone(var_0_1)
