-- chunkname: @scripts/settings/dlcs/cosmetics_2024_q2/cosmetics_cosmetics_2024_q2.lua
...
return {
	skaven_gutter_runner_skin_1001 = {
		...
		first_person_attachment = {
			unit = "units/beings/player/dark_pact_skins/skaven_gutter_runner/skin_1001/first_person/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.skaven_first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/dark_pact_skins/skaven_gutter_runner/skin_1001/third_person/chr_third_person_mesh",
	...
	skaven_pack_master_skin_1001 = {
		...
		dark_pact = true,
		first_person_attachment = {
			unit = "units/beings/player/dark_pact_skins/skaven_pack_master/skin_1001/first_person/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.skaven_first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/dark_pact_skins/skaven_pack_master/skin_1001/third_person/chr_third_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.skaven_third_person_attachment
		},
		always_hide_attachment_slots = {
			"slot_hat"
	...
	skaven_wind_globadier_skin_1001 = {
		...
		dark_pact = true,
		first_person_attachment = {
			unit = "units/beings/player/dark_pact_skins/skaven_wind_globadier/skin_1001/first_person/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.skaven_first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/dark_pact_skins/skaven_wind_globadier/skin_1001/third_person/chr_third_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.skaven_wind_globadier_third_person_attachment
		},
		always_hide_attachment_slots = {
			"slot_hat"
		}
	...
	skaven_warpfire_thrower_skin_1001 = {
		...
		dark_pact = true,
		first_person_attachment = {
			unit = "units/beings/player/dark_pact_skins/skaven_warpfire_thrower/skin_1001/first_person/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.skaven_first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/dark_pact_skins/skaven_warpfire_thrower/skin_1001/third_person/chr_third_person_mesh",
	...
	skaven_ratling_gunner_skin_1001 = {
		...
		dark_pact = true,
		first_person_attachment = {
			unit = "units/beings/player/dark_pact_skins/skaven_ratlinggunner/skin_1001/first_person/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.skaven_first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/dark_pact_skins/skaven_ratlinggunner/skin_1001/third_person/chr_third_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.skaven_third_person_attachment_backpack
		},
		always_hide_attachment_slots = {
			"slot_hat"
