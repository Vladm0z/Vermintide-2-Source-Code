-- chunkname: @scripts/settings/dlcs/cosmetics_2022_q2/cosmetics_cosmetics_2022_q2.lua
...
return {
	skin_bw_scholar_1001 = {
		...
		first_person_attachment = {
			unit = "units/beings/player/bright_wizard_scholar_skin_01/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/bright_wizard_scholar_skin_01/third_person_base/chr_third_person_mesh",
	...
	skin_dr_ironbreaker_1001 = {
		...
		equip_hat_event = "show_beard_1001",
		third_person_husk = "units/beings/player/third_person_base/dwarf_ranger/chr_third_person_husk_base",
		first_person = "units/beings/player/first_person_base/chr_first_person_base",
		first_person_attachment = {
			unit = "units/beings/player/dwarf_ranger_ironbreaker_skin_01/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/dwarf_ranger_ironbreaker_skin_01/third_person_base/chr_third_person_mesh",
	...
	skin_es_huntsman_1001 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/empire_soldier_huntsman_skin_01/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/empire_soldier_huntsman_skin_01/third_person_base/chr_third_person_mesh",
	...
	skin_ww_maidenguard_1001 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/way_watcher_maiden_guard_skin_01/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/way_watcher_maiden_guard_skin_01/third_person_base/chr_third_person_mesh",
	...
	skin_wh_flagellant = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/witch_hunter_flagellant/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/witch_hunter_flagellant/third_person_base/chr_third_person_mesh",
