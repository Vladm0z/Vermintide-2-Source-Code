...
var_0_0.dialogue_settings = {
	dlc_castle = {
		...
		"dialogues/generated/bright_wizard_dlc_drachenfels_castle",
		"dialogues/generated/dwarf_ranger_dlc_drachenfels_castle",
...
var_0_0.network_sound_events = {
	...
	"Play_sorcerer_boss_fly_charge",
	"Play_sorcerer_boss_flies_curse_loop",
	"Stop_sorcerer_boss_flies_curse_loop",
