...
var_0_0.dialogue_lookup = {
	...
	"dialogues/generated/lookup_dwarf_ranger_dlc_drachenfels_bastion",
...
var_0_0.dialogue_settings = {
	dlc_bastion = {
		...
		"dialogues/generated/bright_wizard_dlc_drachenfels_bastion",
		"dialogues/generated/dwarf_ranger_dlc_drachenfels_bastion",
