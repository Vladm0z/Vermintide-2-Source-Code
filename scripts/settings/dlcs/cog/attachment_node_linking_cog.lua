-- chunkname: @scripts/settings/dlcs/cog/attachment_node_linking_cog.lua

AttachmentNodeLinking.steam_pistol = {
	first_person = {
		wielded = {
			{
				target = 0,
...
AttachmentNodeLinking.coghammer = {
	first_person = {
		wielded = {
			{
				target = 0,
			...
			{
				target = "j_cog_c_shaft",
				source = "j_rightweaponcomponent1"
			},
			{
				target = "j_cog_r_small",
				source = "j_rightweaponcomponent2"
			},
			{
				target = "j_cog_r_large",
				source = "j_rightweaponcomponent3"
			},
			{
				target = "j_cog_l_small",
				source = "j_rightweaponcomponent4"
			},
			{
				target = "j_cog_c_small",
				source = "j_rightweaponcomponent5"
			},
			{
				target = "j_head",
...
AttachmentNodeLinking.rotary_gun = {
	first_person = {
		wielded = {
			{
				target = 0,
