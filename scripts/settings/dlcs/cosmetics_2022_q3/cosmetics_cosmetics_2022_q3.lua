-- chunkname: @scripts/settings/dlcs/cosmetics_2022_q3/cosmetics_cosmetics_2022_q3.lua
...
return {
	skin_bw_unchained_1002 = {
		...
		first_person_attachment = {
			unit = "units/beings/player/bright_wizard_unchained_skin_02/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/bright_wizard_unchained_skin_02/third_person_base/chr_third_person_mesh",
	...
	skin_dr_ranger_1002 = {
		...
		first_person = "units/beings/player/first_person_base/chr_first_person_base",
		first_person_attachment = {
			unit = "units/beings/player/dwarf_ranger_upgraded_skin_02/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/dwarf_ranger_upgraded_skin_02/third_person_base/chr_third_person_mesh",
	...
	skin_es_knight_1002 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/empire_soldier_knight_skin_02/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/empire_soldier_knight_skin_02/third_person_base/chr_third_person_mesh",
	...
	skin_ww_shade_1002 = {
		...
		equip_hat_event = "show_balaclava_1002",
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/way_watcher_shade_skin_02/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/way_watcher_shade_skin_02/third_person_base/chr_third_person_mesh",
	...
	skin_wh_bountyhunter_1002 = {
		...
		unit = "",
		first_person_attachment = {
			unit = "units/beings/player/witch_hunter_bounty_hunter_skin_02/first_person_base/chr_first_person_mesh",
			attachment_node_linking = AttachmentNodeLinking.first_person_attachment
		},
		third_person_attachment = {
			unit = "units/beings/player/witch_hunter_bounty_hunter_skin_02/third_person_base/chr_third_person_mesh",
