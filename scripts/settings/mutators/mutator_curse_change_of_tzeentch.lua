...
var_0_1.server_start_function = function (arg_1_0, arg_1_1)
	var_0_0.server_start_function(arg_1_0, arg_1_1)

	arg_1_1.seed = Managers.mechanism:get_level_seed("mutator")
end

var_0_1.server_ai_killed_function = function (arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5)
	local var_2_0
	local var_2_1
...
var_0_1.on_split_enemy = function (arg_3_0)
