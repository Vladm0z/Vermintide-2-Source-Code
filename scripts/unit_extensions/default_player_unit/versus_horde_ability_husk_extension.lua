...
VersusHordeAbilityHuskExtension.init = function (arg_1_0, arg_1_1, arg_1_2, arg_1_3)
...
VersusHordeAbilityHuskExtension.set_ability_game_object_id = function (arg_3_0, arg_3_1)
	arg_3_0.ability_go_id = arg_3_1
end

VersusHordeAbilityHuskExtension.get_ability_charge = function (arg_4_0)
