...
function CareerAbilitySorcererTeleport.init(arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
...
function CareerAbilitySorcererTeleport.extensions_ready(arg_2_0, arg_2_1, arg_2_2)
...
function CareerAbilitySorcererTeleport.destroy(arg_3_0)
	return
end

function CareerAbilitySorcererTeleport._ability_available(arg_4_0)
...
function CareerAbilitySorcererTeleport.update(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4, arg_5_5)
...
function CareerAbilitySorcererTeleport.finish(arg_6_0, arg_6_1)
	return
end

function CareerAbilitySorcererTeleport.stop(arg_7_0, arg_7_1)
	return
end
