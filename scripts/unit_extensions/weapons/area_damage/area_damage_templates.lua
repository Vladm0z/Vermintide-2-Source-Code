	...
	globadier_area_dot_damage = {
		server = {
			update = function (arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4, arg_1_5, arg_1_6, arg_1_7, arg_1_8, arg_1_9, arg_1_10, arg_1_11)
				...
				if arg_1_7 >= 0 and arg_1_7 < arg_1_6 then
					return false
				end
			...
			do_damage = function (arg_2_0, arg_2_1, arg_2_2, arg_2_3)
				...
				DamageUtils.add_damage_network(var_2_0, arg_2_1, var_2_1, "torso", "damage_over_time", nil, Vector3(1, 0, 0), var_2_2, var_2_3, arg_2_2, nil, nil, nil, nil, nil, nil, nil, nil, 1)

				local var_2_4 = ScriptUnit.has_extension(var_2_0, "status_system")

				if var_2_4 and var_2_1 > 0 then
					local var_2_5 = arg_2_3.parent

					var_2_4:hit_by_globadier_poison(var_2_5)
				end
			end
		},
		client = {
	...
	sorcerer_area_dot_damage = {
		server = {
			...
			do_damage = function (arg_7_0, arg_7_1, arg_7_2)
				...
				DamageUtils.add_damage_network(var_7_0, unit, var_7_1, "torso", "damage_over_time", nil, Vector3(1, 0, 0), var_7_2, var_7_3, arg_7_2, nil, nil, nil, nil, nil, nil, nil, nil, 1)
			end
		},
		client = {
		...
		server = {
			update = function (arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4, arg_11_5, arg_11_6, arg_11_7, arg_11_8, arg_11_9, arg_11_10, arg_11_11)
				...
				if (var_11_3 or var_11_4) and (arg_11_7 <= 0 or arg_11_6 <= arg_11_7) then
					...
					var_11_5 = AiUtils.broadphase_query(var_11_0, arg_11_2, var_0_0, var_11_6)
				end
				...
				if var_11_4 and var_11_5 then
					...
					for iter_11_0 = 1, var_11_5 do
						local var_11_12 = var_11_11[var_0_0[iter_11_0]]
				...
				if var_11_3 and var_11_5 then
					...
					for iter_11_1 = 1, var_11_5 do
						local var_11_15 = var_0_0[iter_11_1]
						local var_11_16 = {
	...
	area_poison_ai_random_death = {
		server = {
			update = function (arg_15_0, arg_15_1, arg_15_2, arg_15_3, arg_15_4)
				...
				local var_15_1 = {}
				local var_15_2 = AiUtils.broadphase_query(var_15_0, arg_15_2, var_0_0)

				for iter_15_0 = 1, var_15_2 do
					local var_15_3 = var_0_0[iter_15_0]
