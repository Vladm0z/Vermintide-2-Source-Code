...
GenericUnitAimExtension.init = function (arg_1_0, arg_1_1, arg_1_2, arg_1_3)
...
GenericUnitAimExtension.extensions_ready = function (arg_2_0)
...
GenericUnitAimExtension.destroy = function (arg_3_0)
...
GenericUnitAimExtension.set_enabled = function (arg_5_0, arg_5_1)
	arg_5_0.enabled = arg_5_1
end

GenericUnitAimExtension.update = function (arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4, arg_6_5)
