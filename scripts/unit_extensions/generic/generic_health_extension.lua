...
for iter_0_0, iter_0_1 in ipairs(var_0_0) do
	DamageDataIndex[iter_0_1] = iter_0_0
end

DamageDataIndex.STRIDE = #var_0_0
...
function GenericHealthExtension.save_kill_feed_data(arg_34_0, arg_34_1, arg_34_2, arg_34_3, arg_34_4, arg_34_5, arg_34_6)
	...
	if arg_34_4 ~= "temporary_health_degen" and arg_34_4 ~= "knockdown_bleed" and var_34_3 > 0 then
		...
		if HEALTH_ALIVE[arg_34_1] then
			local var_34_4 = Unit.get_data(arg_34_1, "breed")

			if not (arg_34_1 == var_34_0 and var_34_4 and not var_34_4.is_player) and (arg_34_1 ~= var_34_0 or arg_34_4 ~= "cutting") and var_34_4 then
				var_34_1.breed = var_34_4
				var_34_1.damage_type = arg_34_4
				var_34_1.attacker_unit_id = Managers.state.network:unit_game_object_id(arg_34_1)
				var_34_2 = true

				local var_34_5 = Managers.player:owner(arg_34_1)

				if var_34_5 then
					var_34_1.attacker_unique_id = var_34_5:unique_id()
					var_34_1.attacker_side = Managers.state.side.side_by_unit[arg_34_1]
				else
	...
	if not var_34_2 then
		local var_34_6 = Managers.state.entity:system("area_damage_system"):has_source_attacker_unit_data(arg_34_1)

		if var_34_6 then
			var_34_1.breed = var_34_6.breed
			var_34_1.attacker_unique_id = var_34_6.attacker_unique_id
			var_34_1.attacker_side = var_34_6.attacker_side
		end
	end
end
...
function GenericHealthExtension._register_attacker(arg_35_0, arg_35_1, arg_35_2, arg_35_3)
	...
	local var_35_2 = arg_35_3 + var_0_2
