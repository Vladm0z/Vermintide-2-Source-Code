...
function VersusTargetObjectiveExtension._set_objective_data(arg_1_0, arg_1_1)
...
function VersusTargetObjectiveExtension._activate(arg_2_0)
	return
end

function VersusTargetObjectiveExtension.extensions_ready(arg_3_0)
...
function VersusTargetObjectiveExtension._deactivate(arg_4_0)
	return
end

function VersusTargetObjectiveExtension._store_position(arg_5_0)
	return
end

function VersusTargetObjectiveExtension._server_update(arg_6_0, arg_6_1, arg_6_2)
...
function VersusTargetObjectiveExtension._client_update(arg_7_0, arg_7_1, arg_7_2)
	arg_7_0._health = arg_7_0._health_extension:current_health()
end

function VersusTargetObjectiveExtension.get_percentage_done(arg_8_0)
