...
QuestChallengePropExtension.init = function (arg_1_0, arg_1_1, arg_1_2)
...
QuestChallengePropExtension.update = function (arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, arg_2_5)
...
QuestChallengePropExtension._update_unclaimed_achievement_status = function (arg_3_0, arg_3_1, arg_3_2)
...
QuestChallengePropExtension._update_unclaimed_quests_status = function (arg_4_0, arg_4_1, arg_4_2)
...
QuestChallengePropExtension._evaluate_highlight_status = function (arg_5_0)
	local var_5_0
...
QuestChallengePropExtension._highlight_on = function (arg_6_0)
	Unit.flow_event(arg_6_0._unit, "highlight_on")

	arg_6_0._highlighted = true
end

QuestChallengePropExtension._highlight_off = function (arg_7_0)
