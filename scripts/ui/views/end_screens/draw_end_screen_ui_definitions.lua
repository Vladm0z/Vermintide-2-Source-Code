...
local var_0_2 = {
	title_text = UIWidgets.create_simple_text(Localize("carousel_draw"), "title_text_draw", nil, nil, var_0_1),
	...
	draw = {
		{
			...
			update = function (arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4)
				...
				local var_2_3 = arg_2_1.end_screen_banner_draw.size

				arg_2_0.end_screen_banner_draw.size[1] = var_2_3[1] + var_2_3[1] * 3 * var_2_2
				arg_2_0.end_screen_banner_draw.size[2] = var_2_3[2] + var_2_3[2] * 3 * var_2_2
			end,
