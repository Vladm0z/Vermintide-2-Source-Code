...
VersusDrawEndScreenUI._update = function (arg_3_0, arg_3_1)
	...
	if arg_3_0._draw_anim_id and arg_3_0._ui_animator:is_animation_completed(arg_3_0._draw_anim_id) then
		arg_3_0._draw_anim_id = nil
	end

	if arg_3_0._draw_anim_id == nil then
