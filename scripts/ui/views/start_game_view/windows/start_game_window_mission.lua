-- chunkname: @scripts/ui/views/start_game_view/windows/start_game_window_mission.lua

local var_0_0 = local_require("scripts/ui/views/start_game_view/windows/definitions/start_game_window_mission_definitions")
