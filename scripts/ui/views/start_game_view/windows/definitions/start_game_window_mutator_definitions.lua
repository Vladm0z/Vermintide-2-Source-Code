...
local var_0_8 = {
	...
	description_text = UIWidgets.create_simple_text(Localize("start_game_window_mutator_desc"), "description_text", nil, nil, var_0_7),
	mutator_title = UIWidgets.create_simple_text(Localize("start_game_window_mutator_title"), "mutator_title", nil, nil, var_0_6),
