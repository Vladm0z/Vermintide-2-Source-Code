...
local function var_0_9(arg_27_0, arg_27_1)
	local var_27_0 = "game_options_bg_05"
	local var_27_1 = UIAtlasHelper.get_atlas_settings_by_texture_name(var_27_0)
	local var_27_2 = "menu_frame_08"
	local var_27_3 = UIFrameSettings[var_27_2]
	local var_27_4 = var_27_3.texture_sizes.corner[1]
	...
	return {
			...
			passes = {
				...
				},
				{
					...
					content_check_function = function (arg_32_0)
						return not arg_32_0.button_hotspot.disable_button
					end
				},
				{
					style_id = "title_text_shadow",
				...
				},
				{
					...
					content_check_function = function (arg_33_0)
						return arg_33_0.button_hotspot.disable_button
					end
				},
				{
					pass_type = "texture",
		...
		style = {
			frame = {
				...
				size = arg_27_1,
				texture_size = var_27_3.texture_size,
				texture_sizes = var_27_3.texture_sizes
			},
			background = {
				saturated = true,
				texture_tiling_size = {
...
local var_0_10 = {
	...
	game_option_reward = var_0_9("game_option_reward", var_0_7.game_option_reward.size),
