...
local function var_0_14(arg_7_0, arg_7_1)
	...
	var_7_1.element.passes = var_7_2
	var_7_1.content = var_7_3
	var_7_1.style = var_7_4
	var_7_1.offset = arg_7_1 or {
		0,
		0,
		0
	}
	var_7_1.scenegraph_id = arg_7_0
...
local var_0_17 = {
	...
	info_window = UIWidgets.create_frame("info_window", var_0_2, var_0_1, 10),
	window = UIWidgets.create_frame("window", var_0_6, var_0_1, 10),
	level_title = UIWidgets.create_simple_text("level_title", "level_title", nil, nil, var_0_11),
	selected_level = var_0_14("level_texture_frame"),
	...
	description_text = UIWidgets.create_simple_text("", "description_text", nil, nil, var_0_10),
	helper_text = UIWidgets.create_simple_text(Localize("tutorial_map"), "helper_text", nil, nil, var_0_13),
	mission_selection_title = UIWidgets.create_simple_text(Localize("start_game_window_mission_selection_header"), "mission_selection_title", nil, nil, var_0_12),
	title_divider = var_0_15("title_divider", var_0_9.title_divider.size),
	select_button = UIWidgets.create_default_button("select_button", var_0_9.select_button.size, nil, nil, Localize("menu_select"), 32, nil, nil, nil, var_0_16)
}

for iter_0_0 = 1, 20 do
	var_0_9["level_root_" .. iter_0_0] = {
		vertical_alignment = "center",
