...
function CraftPageRollPropertiesConsole.on_enter(arg_1_0, arg_1_1, arg_1_2)
...
function CraftPageRollPropertiesConsole.setup_recipe_requirements(arg_2_0)
...
function CraftPageRollPropertiesConsole.reset_requirements(arg_3_0, arg_3_1)
...
function CraftPageRollPropertiesConsole.create_ui_elements(arg_4_0, arg_4_1)
...
function CraftPageRollPropertiesConsole.on_exit(arg_5_0, arg_5_1)
...
function CraftPageRollPropertiesConsole.update(arg_6_0, arg_6_1, arg_6_2)
	if var_0_8 then
		var_0_8 = false
...
function CraftPageRollPropertiesConsole.post_update(arg_7_0, arg_7_1, arg_7_2)
	return
end

function CraftPageRollPropertiesConsole._update_animations(arg_8_0, arg_8_1)
...
function CraftPageRollPropertiesConsole._is_button_pressed(arg_9_0, arg_9_1)
...
function CraftPageRollPropertiesConsole._is_button_hovered(arg_10_0, arg_10_1)
	if arg_10_1.content.button_hotspot.on_hover_enter then
		return true
	end
end

function CraftPageRollPropertiesConsole._is_button_held(arg_11_0, arg_11_1)
...
function CraftPageRollPropertiesConsole._handle_input(arg_12_0, arg_12_1, arg_12_2)
...
function CraftPageRollPropertiesConsole._handle_craft_input_progress(arg_13_0, arg_13_1)
	return arg_13_0.parent:_set_input_progress(arg_13_1)
end

function CraftPageRollPropertiesConsole.craft_result(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	if not arg_14_2 then
		arg_14_0._craft_result = arg_14_1
	end
end

function CraftPageRollPropertiesConsole.reset(arg_15_0)
...
function CraftPageRollPropertiesConsole.present_results(arg_16_0)
...
function CraftPageRollPropertiesConsole.on_craft_completed(arg_17_0)
...
function CraftPageRollPropertiesConsole._update_craft_items(arg_18_0)
...
function CraftPageRollPropertiesConsole._remove_craft_item(arg_19_0, arg_19_1, arg_19_2, arg_19_3)
...
function CraftPageRollPropertiesConsole._add_craft_item(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
...
function CraftPageRollPropertiesConsole._set_craft_button_disabled(arg_21_0, arg_21_1)
...
function CraftPageRollPropertiesConsole._exit(arg_22_0, arg_22_1)
	arg_22_0.exit = true
	arg_22_0.exit_level_id = arg_22_1
end

function CraftPageRollPropertiesConsole.draw(arg_23_0, arg_23_1)
...
function CraftPageRollPropertiesConsole._play_sound(arg_24_0, arg_24_1)
	arg_24_0.super_parent:play_sound(arg_24_1)
end

function CraftPageRollPropertiesConsole._set_craft_button_text(arg_25_0, arg_25_1, arg_25_2)
	arg_25_0._widgets_by_name.craft_button.content.button_text = arg_25_2 and Localize(arg_25_1) or arg_25_1
end

function CraftPageRollPropertiesConsole._add_crafting_material_requirement(arg_26_0, arg_26_1, arg_26_2, arg_26_3, arg_26_4)
...
function CraftPageRollPropertiesConsole._clear_item_grid(arg_27_0)
...
function CraftPageRollPropertiesConsole._has_added_item_by_id(arg_28_0, arg_28_1)
