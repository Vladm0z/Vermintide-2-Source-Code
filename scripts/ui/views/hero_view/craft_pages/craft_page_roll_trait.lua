...
CraftPageRollTrait.on_enter = function (arg_1_0, arg_1_1, arg_1_2)
...
CraftPageRollTrait.setup_recipe_requirements = function (arg_2_0)
...
CraftPageRollTrait.create_ui_elements = function (arg_3_0, arg_3_1)
...
CraftPageRollTrait.on_exit = function (arg_4_0, arg_4_1)
...
CraftPageRollTrait.update = function (arg_5_0, arg_5_1, arg_5_2)
	if var_0_8 then
		var_0_8 = false
...
CraftPageRollTrait.post_update = function (arg_6_0, arg_6_1, arg_6_2)
	return
end

CraftPageRollTrait._update_animations = function (arg_7_0, arg_7_1)
...
CraftPageRollTrait._is_button_pressed = function (arg_8_0, arg_8_1)
...
CraftPageRollTrait._is_button_hovered = function (arg_9_0, arg_9_1)
	if arg_9_1.content.button_hotspot.on_hover_enter then
		return true
	end
end

CraftPageRollTrait._is_button_held = function (arg_10_0, arg_10_1)
...
CraftPageRollTrait._handle_input = function (arg_11_0, arg_11_1, arg_11_2)
...
CraftPageRollTrait._handle_craft_input_progress = function (arg_12_0, arg_12_1)
	local var_12_0
...
CraftPageRollTrait.craft_result = function (arg_13_0, arg_13_1, arg_13_2, arg_13_3)
	if not arg_13_2 then
		arg_13_0._craft_result = arg_13_1
	end
end

CraftPageRollTrait.reset = function (arg_14_0)
...
CraftPageRollTrait.on_craft_completed = function (arg_15_0)
...
CraftPageRollTrait._update_craft_items = function (arg_16_0)
...
CraftPageRollTrait._remove_craft_item = function (arg_17_0, arg_17_1, arg_17_2, arg_17_3)
...
CraftPageRollTrait._add_craft_item = function (arg_18_0, arg_18_1, arg_18_2, arg_18_3)
...
CraftPageRollTrait._set_craft_button_disabled = function (arg_19_0, arg_19_1)
	arg_19_0._widgets_by_name.craft_button.content.button_hotspot.disable_button = arg_19_1
end

CraftPageRollTrait._exit = function (arg_20_0, arg_20_1)
	arg_20_0.exit = true
	arg_20_0.exit_level_id = arg_20_1
end

CraftPageRollTrait.draw = function (arg_21_0, arg_21_1)
...
CraftPageRollTrait._play_sound = function (arg_22_0, arg_22_1)
	arg_22_0.super_parent:play_sound(arg_22_1)
end

CraftPageRollTrait._set_craft_button_text = function (arg_23_0, arg_23_1, arg_23_2)
