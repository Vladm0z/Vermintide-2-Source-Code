-- chunkname: @scripts/ui/views/hero_view/craft_pages/definitions/craft_page_apply_skin_definitions.lua
...
local var_0_10 = {
	...
	item_grid_2 = UIWidgets.create_grid("item_grid_2", var_0_8.item_grid_2.size, NUM_RECIPE_SLOTS_Y, NUM_RECIPE_SLOTS_X, 30, 30),
	...
	craft_button = UIWidgets.create_default_button("craft_button", var_0_8.craft_button.size, nil, nil, Localize("hero_view_crafting_apply_skin"), 24, nil, "button_detail_02", nil, var_0_9),
