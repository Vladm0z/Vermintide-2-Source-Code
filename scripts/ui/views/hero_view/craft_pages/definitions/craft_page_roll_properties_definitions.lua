-- chunkname: @scripts/ui/views/hero_view/craft_pages/definitions/craft_page_roll_properties_definitions.lua
...
local var_0_10 = {
	...
	craft_button = UIWidgets.create_default_button("craft_button", var_0_8.craft_button.size, nil, nil, Localize("hero_view_crafting_properties"), 24, nil, "button_detail_02", nil, var_0_9),
