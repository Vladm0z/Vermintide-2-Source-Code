...
function CraftPageCraftItemConsole.on_enter(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0._item_grid = ItemGridUI:new(var_0_5, arg_1_0._widgets_by_name.item_grid, arg_1_0.hero_name, arg_1_0.career_index, arg_1_0._params)
...
function CraftPageCraftItemConsole.setup_recipe_requirements(arg_2_0)
	...
	arg_2_0:reset_requirements(var_2_8)
	...
	for iter_2_2, iter_2_3 in ipairs(var_2_7) do
		if not iter_2_3.catergory then
			local var_2_14 = iter_2_3.name
			local var_2_15 = iter_2_3.amount
			local var_2_16 = 0
			local var_2_17

			for iter_2_4, iter_2_5 in ipairs(var_2_11) do
				local var_2_18 = iter_2_5.backend_id

				if iter_2_5.data.key == var_2_14 then
					var_2_17 = var_2_18
					var_2_16 = var_2_10:get_item_amount(var_2_18)

					break
				end
			end

			local var_2_19 = var_2_15 <= var_2_16
			local var_2_20 = (var_2_16 < UISettings.max_craft_material_presentation_amount and tostring(var_2_16) or "*") .. "/" .. tostring(var_2_15)

			arg_2_0:_add_crafting_material_requirement(var_2_13, var_2_14, var_2_20, var_2_19)

			var_2_13 = var_2_13 + 1

			if var_2_19 then
				var_2_9[#var_2_9 + 1] = var_2_17
			else
				var_2_12 = false
			end
		end
...
function CraftPageCraftItemConsole.reset_requirements(arg_3_0, arg_3_1)
...
function CraftPageCraftItemConsole.create_ui_elements(arg_4_0, arg_4_1)
...
function CraftPageCraftItemConsole.on_exit(arg_5_0, arg_5_1)
	...
	arg_5_0.super_parent:disable_filter(false)
	arg_5_0.super_parent:disable_search(false)
end

function CraftPageCraftItemConsole.update(arg_6_0, arg_6_1, arg_6_2)
	if var_0_8 then
		var_0_8 = false
...
function CraftPageCraftItemConsole.post_update(arg_7_0, arg_7_1, arg_7_2)
	return
end

function CraftPageCraftItemConsole._update_animations(arg_8_0, arg_8_1)
...
function CraftPageCraftItemConsole._is_button_pressed(arg_9_0, arg_9_1)
...
function CraftPageCraftItemConsole._is_button_hovered(arg_10_0, arg_10_1)
	if arg_10_1.content.button_hotspot.on_hover_enter then
		return true
	end
end

function CraftPageCraftItemConsole._is_button_held(arg_11_0, arg_11_1)
...
function CraftPageCraftItemConsole._handle_input(arg_12_0, arg_12_1, arg_12_2)
	...
	if var_12_9 then
		...
		if var_12_0:craft(var_12_14) then
...
function CraftPageCraftItemConsole._handle_craft_input_progress(arg_13_0, arg_13_1)
	return arg_13_0.parent:_set_input_progress(arg_13_1)
end

function CraftPageCraftItemConsole.craft_result(arg_14_0, arg_14_1, arg_14_2, arg_14_3)
	if not arg_14_2 then
		arg_14_0._craft_result = arg_14_1
	end
end

function CraftPageCraftItemConsole.reset(arg_15_0)
...
function CraftPageCraftItemConsole.present_results(arg_16_0)
...
function CraftPageCraftItemConsole.on_craft_completed(arg_17_0)
	local var_17_0 = arg_17_0._craft_result
	local var_17_1 = arg_17_0._item_grid
	local var_17_2 = true
	local var_17_3 = arg_17_0._craft_items[1]

	if var_17_3 then
		arg_17_0:_add_craft_item(var_17_3, nil, var_17_2)
	end

	local var_17_4 = Managers.backend:get_interface("items")
	local var_17_5 = arg_17_0.parent
	local var_17_6 = arg_17_0._craft_result
	local var_17_7 = true

	for iter_17_0, iter_17_1 in pairs(var_17_6) do
		local var_17_8 = iter_17_1[1]
		local var_17_9 = iter_17_1[3]
		local var_17_10 = var_17_8 and var_17_4:get_item_from_id(var_17_8)

		var_17_5:set_reward_tooltip_item(var_17_10)
	end
...
function CraftPageCraftItemConsole._update_craft_items(arg_18_0)
...
function CraftPageCraftItemConsole._remove_craft_item(arg_19_0, arg_19_1, arg_19_2)
	...
	if arg_19_1 and arg_19_2 then
		...
		arg_19_0._widgets_by_name.item_grid_random_icon.content.visible = true
	end
end

function CraftPageCraftItemConsole._add_craft_item(arg_20_0, arg_20_1, arg_20_2, arg_20_3)
	...
	if arg_20_2 then
		...
		arg_20_0._widgets_by_name.item_grid_random_icon.content.visible = false
	end

	arg_20_0:setup_recipe_requirements()
end

function CraftPageCraftItemConsole._clear_item_grid(arg_21_0)
	local var_21_0 = arg_21_0._craft_items
	local var_21_1 = arg_21_0.super_parent

	for iter_21_0 = 1, var_0_9 do
		if var_21_0[iter_21_0] then
			var_21_1:set_disabled_backend_id(var_21_0[iter_21_0], false)
		end
	end

	arg_21_0._item_grid:clear_item_grid()
	table.clear(var_21_0)
end

function CraftPageCraftItemConsole._has_added_item_by_id(arg_22_0, arg_22_1)
	local var_22_0 = arg_22_0._craft_items

	for iter_22_0 = 1, var_0_9 do
		if var_22_0[iter_22_0] == arg_22_1 then
			return true
		end
	end
...
function CraftPageCraftItemConsole._set_craft_button_disabled(arg_23_0, arg_23_1)
	arg_23_0._widgets_by_name.craft_button.content.button_hotspot.disable_button = arg_23_1

	arg_23_0.parent:set_input_description(not arg_23_1 and arg_23_0.settings.name or "disabled")
end

function CraftPageCraftItemConsole._exit(arg_24_0, arg_24_1)
	arg_24_0.exit = true
	arg_24_0.exit_level_id = arg_24_1
end

function CraftPageCraftItemConsole.draw(arg_25_0, arg_25_1)
...
function CraftPageCraftItemConsole._play_sound(arg_26_0, arg_26_1)
	arg_26_0.super_parent:play_sound(arg_26_1)
end

function CraftPageCraftItemConsole._set_craft_button_text(arg_27_0, arg_27_1, arg_27_2)
	arg_27_0._widgets_by_name.craft_button.content.button_text = arg_27_2 and Localize(arg_27_1) or arg_27_1
end

function CraftPageCraftItemConsole._add_crafting_material_requirement(arg_28_0, arg_28_1, arg_28_2, arg_28_3, arg_28_4)
	local var_28_0 = UISettings.crafting_material_icons_small
	local var_28_1 = arg_28_0._widgets_by_name["material_text_" .. arg_28_1].content

	var_28_1.icon, var_28_1.text = var_28_0[arg_28_2], arg_28_3
	var_28_1.warning = not arg_28_4
	var_28_1.item = {
