...
local var_0_15 = {
	...
	viewport = {
		...
		horizontal_alignment = "center",
		size = {
			var_0_13[1] - var_0_12 * 2,
			var_0_13[2] - var_0_12 * 2
		},
		position = {
			0,
			var_0_12,
...
local function var_0_27(arg_1_0, arg_1_1, arg_1_2)
	local var_1_0 = {
		{
			style_id = "icon",
			pass_type = "hotspot",
...
local function var_0_28(arg_12_0, arg_12_1, arg_12_2)
	local var_12_0 = {
		{
			style_id = "icon",
			pass_type = "hotspot",
...
local function var_0_29(arg_23_0, arg_23_1, arg_23_2)
	local var_23_0 = {
		{
			style_id = "icon",
			pass_type = "hotspot",
...
local function var_0_31(arg_54_0, arg_54_1, arg_54_2)
	local var_54_0 = {
		255,
		255,
		255,
...
local function var_0_32(arg_66_0, arg_66_1, arg_66_2)
	local var_66_0 = {
		255,
		255,
		255,
...
local function var_0_33(arg_79_0, arg_79_1, arg_79_2)
...
local function var_0_34(arg_80_0, arg_80_1)
	local var_80_0 = {
		passes = {
			{
				pass_type = "texture",
...
local function var_0_35(arg_81_0)
	return {
		element = {
			passes = {
				{
...
local var_0_40 = {
	...
	viewport_background_fade = UIWidgets.create_simple_rotated_texture("edge_fade_small", math.pi / 2, {
		var_0_15.viewport_background_fade.size[1],
		0
	}, "viewport_background_fade"),
...
var_0_39.hdr_wheel_ring_1.content.snap_pixel_positions = false
var_0_39.hdr_wheel_ring_2.content.snap_pixel_positions = false
var_0_39.hdr_wheel_ring_3.content.snap_pixel_positions = false
var_0_40.wheel_ring_1.content.snap_pixel_positions = false
var_0_40.wheel_ring_2.content.snap_pixel_positions = false
var_0_40.wheel_ring_3.content.snap_pixel_positions = false

local var_0_41 = {
	upgrade_text = UIWidgets.create_simple_text(Localize("menu_weave_item_upgraded_effect_title"), "upgrade_text", nil, nil, var_0_16),
	...
	viewport_level_title = UIWidgets.create_simple_text(Localize("menu_weave_forge_magic_level_title"), "panel_level_title", nil, nil, var_0_23),
	viewport_level_value = UIWidgets.create_simple_text("0", "panel_level_value", nil, nil, var_0_24),
	viewport_power_title = UIWidgets.create_simple_text(Localize("menu_weave_forge_loadout_power_title"), "panel_power_title", nil, nil, var_0_23),
	viewport_power_value = UIWidgets.create_simple_text("0", "panel_power_value", nil, nil, var_0_24),
	viewport_button = UIWidgets.create_simple_hotspot("viewport_button", true),
	viewport_title = UIWidgets.create_simple_text("", "viewport_title", nil, nil, var_0_25),
	viewport_sub_title = UIWidgets.create_simple_text("", "viewport_sub_title", nil, nil, var_0_26),
	upgrade_essence_warning = UIWidgets.create_simple_text(Localize("menu_weave_forge_level_too_low"), "upgrade_essence_warning", nil, nil, var_0_22),
	upgrade_button = UIWidgets.create_athanor_upgrade_button("upgrade_button", var_0_15.upgrade_button.size, "athanor_icon_upgrade", Localize("menu_weave_forge_upgrade_loadout_button"), 24),
	options_background_edge = UIWidgets.create_simple_texture("athanor_categories_background", "options_background_edge"),
	options_list_button = var_0_35("options_scroll_field"),
	...
	clear_button = UIWidgets.create_default_button("clear_button", var_0_15.clear_button.size, nil, nil, Localize("menu_weave_forge_reset_options_button"), 26, nil, "button_detail_02"),
	mastery_icon = UIWidgets.create_simple_texture("icon_mastery_big", "mastery_icon"),
	mastery_text = UIWidgets.create_simple_text("", "mastery_text", nil, nil, var_0_19),
	mastery_title_text = UIWidgets.create_simple_text(Localize("menu_weave_forge_mastery_title"), "mastery_title_text", nil, nil, var_0_20),
	mastery_tooltip = UIWidgets.create_additional_option_tooltip("mastery_tooltip", var_0_15.mastery_tooltip.size, {
	...
	title_text = UIWidgets.create_simple_text("", "title_text", nil, nil, var_0_17),
	sub_title_text = UIWidgets.create_simple_text("", "sub_title_text", nil, nil, var_0_18),
	...
	locked_slot_description = var_0_34("options_scroll_field", var_0_15.options_scroll_field.size)
}
local var_0_42 = {
	upgrade = {
		{
...
return {
	scrollbar_widget = UIWidgets.create_chain_scrollbar("options_list_scrollbar", "options_scroll_field", var_0_15.options_list_scrollbar.size),
	top_widgets = var_0_41,
	bottom_widgets = var_0_40,
	top_hdr_widgets = var_0_37,
	bottom_hdr_widgets = var_0_39,
	options_mask_margin = var_0_11,
	options_mask_offset = var_0_10,
	scenegraph_definition = var_0_15,
	animation_definitions = var_0_42,
	create_trait_slot_definition = var_0_29,
	create_menu_option_trait_definition = var_0_31,
	create_menu_option_talent_definition = var_0_32,
	create_menu_option_property_definition = var_0_30,
	create_talent_slot_definition = var_0_28,
	create_property_slot_definition = var_0_27
}
