...
local var_0_5 = {
	...
	player_hosted_checkbox = UIWidgets.create_default_checkbox_button_console("player_hosted_checkbox", var_0_3.player_hosted_checkbox.size, "Player Hosted", 24, {
		title = Localize("player_hosted_title"),
		description = Localize("player_hosted_desc")
	}, "menu_frame_03_morris"),
	dedicated_servers_win_checkbox = UIWidgets.create_default_checkbox_button_console("dedicated_servers_win_checkbox", var_0_3.dedicated_servers_win_checkbox.size, "Dedicated servers: Win", 24, {
		title = Localize("dedicated_servers_win_title"),
		description = Localize("dedicated_servers_win_desc")
	}, "menu_frame_03_morris"),
	dedicated_servers_aws_checkbox = UIWidgets.create_default_checkbox_button_console("dedicated_servers_aws_checkbox", var_0_3.dedicated_servers_aws_checkbox.size, "Dedicated servers: AWS", 24, {
