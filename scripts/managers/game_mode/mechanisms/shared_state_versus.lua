...
SharedStateVersus.init = function (arg_1_0, arg_1_1, arg_1_2, arg_1_3, arg_1_4)
...
SharedStateVersus.full_sync = function (arg_2_0)
	arg_2_0._shared_state:full_sync()
end

SharedStateVersus.register_rpcs = function (arg_3_0, arg_3_1)
	arg_3_0._shared_state:register_rpcs(arg_3_1)
end

SharedStateVersus.unregister_rpcs = function (arg_4_0)
	arg_4_0._shared_state:unregister_rpcs()
end

SharedStateVersus.network_context_created = function (arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4, arg_5_5)
	arg_5_0._shared_state:network_context_created(arg_5_1, arg_5_2, arg_5_3, arg_5_4, arg_5_5)
end

SharedStateVersus.destroy = function (arg_6_0)
	arg_6_0._shared_state:destroy()

	arg_6_0._shared_state = nil
end

SharedStateVersus.get_revision = function (arg_7_0)
	return arg_7_0._shared_state:get_revision()
end

SharedStateVersus.is_peer_fully_synced = function (arg_8_0, arg_8_1)
	return arg_8_0._shared_state:is_peer_fully_synced(arg_8_1)
end

SharedStateVersus.get_hero_cosmetics = function (arg_9_0, arg_9_1, arg_9_2)
...
SharedStateVersus.set_hero_cosmetics = function (arg_10_0, arg_10_1, arg_10_2, arg_10_3, arg_10_4, arg_10_5, arg_10_6, arg_10_7, arg_10_8, arg_10_9, arg_10_10)
...
SharedStateVersus.get_match_id = function (arg_16_0)
