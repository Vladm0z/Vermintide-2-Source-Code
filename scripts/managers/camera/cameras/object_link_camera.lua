...
function ObjectLinkCamera.init(arg_1_0, arg_1_1)
	BaseCamera.init(arg_1_0, arg_1_1)

	arg_1_0._curve_params = {}
end

function ObjectLinkCamera.parse_parameters(arg_2_0, arg_2_1, arg_2_2)
...
function ObjectLinkCamera.update(arg_3_0, arg_3_1, arg_3_2, arg_3_3, arg_3_4)
	local var_3_0
	local var_3_1
