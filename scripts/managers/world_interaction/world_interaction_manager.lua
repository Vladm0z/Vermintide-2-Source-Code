...
function WorldInteractionManager.add_simple_effect(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4)
	...
	if Unit.alive(var_6_1) then
		...
		if Vector3.distance_squared(var_6_4, arg_6_3) < var_6_3 * var_6_3 then
			arg_6_0["_add_simple_" .. arg_6_1 .. "_effect"](arg_6_0, arg_6_2, arg_6_3, arg_6_4)
		end
	end
end

function WorldInteractionManager._add_simple_water_effect(arg_7_0, arg_7_1, arg_7_2, arg_7_3)
	local var_7_0 = WorldInteractionSettings.water
	local var_7_1 = arg_7_3 and var_7_0.default_unit_water or var_7_0.default_water
...
function WorldInteractionManager._update_water_data(arg_11_0, arg_11_1, arg_11_2)
	...
	if var_11_3 <= arg_11_0._water_timer then
		...
		local var_11_10 = POSITION_LOOKUP[var_11_8]
		...
		if Unit.alive(var_11_8) and var_11_6 and next(var_11_6) then
			...
			for iter_11_0, iter_11_1 in pairs(var_11_11) do
				...
				if var_11_6[var_11_12] then
					...
					if var_11_13 and Vector3.distance_squared(var_11_13, var_11_10) < var_11_9 * var_11_9 then
