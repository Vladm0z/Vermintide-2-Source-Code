-- chunkname: @dialogues/generated/dwarf_ranger_forest_ambush.lua
	...
	add_dialogues({
		pdr_forest_ambush_intro = {
			...
			localization_strings = {
				[1] = "pdr_forest_ambush_intro_a_01",
				[2] = "pdr_forest_ambush_intro_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pdr_forest_ambush_intro_a_01",
		...
		pdr_forest_ambush_intro_b = {
			...
			localization_strings = {
				[1] = "pdr_forest_ambush_intro_b_01",
				[2] = "pdr_forest_ambush_intro_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pdr_forest_ambush_intro_b_01",
		...
		pdr_forest_ambush_intro_c = {
			...
			localization_strings = {
				[1] = "pdr_forest_ambush_intro_c_01",
				[2] = "pdr_forest_ambush_intro_c_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pdr_forest_ambush_intro_c_01",
