-- chunkname: @dialogues/generated/wood_elf_dlc_wizards_trail.lua
...
return function()
	...
	add_dialogues({
		...
		pwe_wizard_trail_caravan_b = {
			...
			localization_strings = {
				[1] = "pwe_wizard_trail_caravan_b_01",
				[2] = "pwe_wizard_trail_caravan_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwe_wizard_trail_caravan_b_01",
		...
		pwe_wizard_trail_intro_b = {
			...
			localization_strings = {
				[1] = "pwe_wizard_trail_intro_b_01",
				[2] = "pwe_wizard_trail_intro_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwe_wizard_trail_intro_b_01",
		...
		pwe_wizard_trail_intro_c = {
			...
			localization_strings = {
				[1] = "pwe_wizard_trail_intro_c_01",
				[2] = "pwe_wizard_trail_intro_c_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwe_wizard_trail_intro_c_01",
		...
		pwe_wizard_trail_intruders_b = {
			...
			localization_strings = {
				[1] = "pwe_wizard_trail_intruders_b_01",
				[2] = "pwe_wizard_trail_intruders_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwe_wizard_trail_intruders_b_01",
		...
		pwe_wizard_trail_lower_bridge_b = {
			...
			localization_strings = {
				[1] = "pwe_wizard_trail_lower_bridge_b_01",
				[2] = "pwe_wizard_trail_lower_bridge_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwe_wizard_trail_lower_bridge_b_01",
