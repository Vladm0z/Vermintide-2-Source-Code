-- chunkname: @dialogues/generated/witch_hunter_skaven_stronghold.lua
...
return function()
	...
	add_dialogues({
		...
		pwh_level_skaven_stronghold_rat_ogre_rampage = {
			...
			localization_strings = {
				[1] = "pwh_level_skaven_stronghold_rat_ogre_rampage_01"
			},
			sound_events = {
				[1] = "pwh_level_skaven_stronghold_rat_ogre_rampage_01"
			},
		...
		pwh_skaven_stronghold_intro_a = {
			...
			localization_strings = {
				[1] = "pwh_skaven_stronghold_intro_a_01",
				[2] = "pwh_skaven_stronghold_intro_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_skaven_stronghold_intro_a_01",
		...
		pwh_skaven_stronghold_intro_b = {
			...
			localization_strings = {
				[1] = "pwh_skaven_stronghold_intro_b_01",
				[2] = "pwh_skaven_stronghold_intro_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_skaven_stronghold_intro_b_01",
		...
		pwh_skaven_stronghold_intro_c = {
			...
			localization_strings = {
				[1] = "pwh_skaven_stronghold_intro_c_01",
				[2] = "pwh_skaven_stronghold_intro_c_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_skaven_stronghold_intro_c_01",
