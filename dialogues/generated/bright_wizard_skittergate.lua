-- chunkname: @dialogues/generated/bright_wizard_skittergate.lua
...
return function ()
	...
	add_dialogues({
		...
		pbw_level_skittergate_rasknitt_gate_reply = {
			...
			localization_strings = {
				[1] = "pbw_level_skittergate_rasknitt_gate_reply_01",
				[2] = "pbw_level_skittergate_rasknitt_gate_reply_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_level_skittergate_rasknitt_gate_reply_01",
		...
		pbw_level_skittergate_rasknitt_stormfiend_dead = {
			...
			localization_strings = {
				[1] = "pbw_level_skittergate_rasknitt_stormfiend_dead_01",
				[2] = "pbw_level_skittergate_rasknitt_stormfiend_dead_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_level_skittergate_rasknitt_stormfiend_dead_01",
		...
		pbw_skittergate_intro_a = {
			...
			localization_strings = {
				[1] = "pbw_skittergate_intro_a_01",
				[2] = "pbw_skittergate_intro_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_skittergate_intro_a_01",
		...
		pbw_skittergate_intro_b = {
			...
			localization_strings = {
				[1] = "pbw_skittergate_intro_b_01",
				[2] = "pbw_skittergate_intro_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_skittergate_intro_b_01",
		...
		pbw_skittergate_intro_c = {
			...
			localization_strings = {
				[1] = "pbw_skittergate_intro_c_01",
				[2] = "pbw_skittergate_intro_c_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_skittergate_intro_c_01",
