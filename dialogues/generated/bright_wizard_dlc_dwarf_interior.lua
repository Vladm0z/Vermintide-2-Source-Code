-- chunkname: @dialogues/generated/bright_wizard_dlc_dwarf_interior.lua
...
return function ()
	...
	add_dialogues({
		...
		pbw_dwarf_internal_engineer_reveal_b = {
			...
			localization_strings = {
				[1] = "pbw_dwarf_internal_engineer_reveal_b_01",
				[2] = "pbw_dwarf_internal_engineer_reveal_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_dwarf_internal_engineer_reveal_b_01",
		...
		pbw_dwarf_internal_start_banter_a = {
			...
			localization_strings = {
				[1] = "pbw_dwarf_internal_start_banter_a_01",
				[2] = "pbw_dwarf_internal_start_banter_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_dwarf_internal_start_banter_a_01",
		...
		pbw_dwarf_internal_start_banter_b = {
			...
			localization_strings = {
				[1] = "pbw_dwarf_internal_start_banter_b_01",
				[2] = "pbw_dwarf_internal_start_banter_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_dwarf_internal_start_banter_b_01",
		...
		pbw_dwarf_internal_start_banter_c = {
			...
			localization_strings = {
				[1] = "pbw_dwarf_internal_start_banter_c_01",
				[2] = "pbw_dwarf_internal_start_banter_c_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_dwarf_internal_start_banter_c_01",
