-- chunkname: @dialogues/generated/witch_hunter_dlc_dwarf_beacons.lua
...
return function()
	...
	add_dialogues({
		...
		pwh_dwarf_beacons_head_for_heights_a = {
			...
			localization_strings = {
				[1] = "pwh_dwarf_beacons_head_for_heights_a_01",
				[2] = "pwh_dwarf_beacons_head_for_heights_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_dwarf_beacons_head_for_heights_a_01",
		...
		pwh_dwarf_beacons_head_for_heights_b = {
			...
			localization_strings = {
				[1] = "pwh_dwarf_beacons_head_for_heights_b_01",
				[2] = "pwh_dwarf_beacons_head_for_heights_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_dwarf_beacons_head_for_heights_b_01",
		...
		pwh_dwarf_beacons_start_banter_a = {
			...
			localization_strings = {
				[1] = "pwh_dwarf_beacons_start_banter_a_01",
				[2] = "pwh_dwarf_beacons_start_banter_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_dwarf_beacons_start_banter_a_01",
		...
		pwh_dwarf_beacons_start_banter_b = {
			...
			localization_strings = {
				[1] = "pwh_dwarf_beacons_start_banter_b_01",
				[2] = "pwh_dwarf_beacons_start_banter_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_dwarf_beacons_start_banter_b_01",
		...
		pwh_dwarf_beacons_start_banter_c = {
			...
			localization_strings = {
				[1] = "pwh_dwarf_beacons_start_banter_c_01",
				[2] = "pwh_dwarf_beacons_start_banter_c_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_dwarf_beacons_start_banter_c_01",
