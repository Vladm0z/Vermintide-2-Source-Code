-- chunkname: @dialogues/generated/dwarf_ranger_military.lua
	...
	add_dialogues({
		pdr_helmgart_military_a = {
			...
			localization_strings = {
				[1] = "pdr_helmgart_military_intro_a_01",
				[2] = "pdr_helmgart_military_intro_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pdr_helmgart_military_intro_a_01",
		...
		pdr_helmgart_military_b = {
			...
			localization_strings = {
				[1] = "pdr_helmgart_military_intro_b_01",
				[2] = "pdr_helmgart_military_intro_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pdr_helmgart_military_intro_b_01",
		...
		pdr_helmgart_military_c = {
			...
			localization_strings = {
				[1] = "pdr_helmgart_military_intro_c_01",
				[2] = "pdr_helmgart_military_intro_c_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pdr_helmgart_military_intro_c_01",
