-- chunkname: @dialogues/generated/witch_hunter_ground_zero.lua
	...
	add_dialogues({
		pwh_ground_zero_intro_a = {
			...
			localization_strings = {
				[1] = "pwh_ground_zero_intro_a_01",
				[2] = "pwh_ground_zero_intro_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_ground_zero_intro_a_01",
		...
		pwh_ground_zero_intro_b = {
			...
			localization_strings = {
				[1] = "pwh_ground_zero_intro_b_01",
				[2] = "pwh_ground_zero_intro_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_ground_zero_intro_b_01",
		...
		pwh_ground_zero_intro_c = {
			...
			localization_strings = {
				[1] = "pwh_ground_zero_intro_c_01",
				[2] = "pwh_ground_zero_intro_c_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_ground_zero_intro_c_01",
		...
		pwh_level_ground_zero_boss_taunt_reply = {
			...
			localization_strings = {
				[1] = "pwh_level_ground_zero_boss_taunt_reply_01",
				[2] = "pwh_level_ground_zero_boss_taunt_reply_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_level_ground_zero_boss_taunt_reply_01",
		...
		pwh_level_ground_zero_complete = {
			...
			localization_strings = {
				[1] = "pwh_level_ground_zero_complete_01",
				[2] = "pwh_level_ground_zero_complete_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwh_level_ground_zero_complete_01",
