-- chunkname: @dialogues/generated/bright_wizard_ground_zero.lua
	...
	add_dialogues({
		pbw_ground_zero_intro_a = {
			...
			localization_strings = {
				[1] = "pbw_ground_zero_intro_a_01",
				[2] = "pbw_ground_zero_intro_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_ground_zero_intro_a_01",
		...
		pbw_ground_zero_intro_b = {
			...
			localization_strings = {
				[1] = "pbw_ground_zero_intro_b_01",
				[2] = "pbw_ground_zero_intro_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_ground_zero_intro_b_01",
		...
		pbw_ground_zero_intro_c = {
			...
			localization_strings = {
				[1] = "pbw_ground_zero_intro_c_01",
				[2] = "pbw_ground_zero_intro_c_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pbw_ground_zero_intro_c_01",
