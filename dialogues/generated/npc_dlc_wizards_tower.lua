-- chunkname: @dialogues/generated/npc_dlc_wizards_tower.lua
...
return function ()
	...
	add_dialogues({
		...
		nfl_wizard_tower_cutscene_b = {
			...
			localization_strings = {
				[1] = "nfl_wizard_tower_cutscene_b_02",
				[2] = "nfl_wizard_tower_cutscene_b_04"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "nfl_wizard_tower_cutscene_b_02",
		...
		nfl_wizard_tower_ready_end_event = {
			...
			localization_strings = {
				[1] = "nfl_wizard_tower_challenge_01"
			},
			sound_events = {
				[1] = "nfl_wizard_tower_challenge_01"
			},
		...
		nsf_wizard_tower_block_well = {
			...
			localization_strings = {
				[1] = "nsf_wizard_tower_spellcasting_01",
				[2] = "nsf_wizard_tower_spellcasting_05"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "nsf_wizard_tower_spellcasting_01",
		...
		nsf_wizard_tower_library_two_long_a = {
			...
			localization_strings = {
				[1] = "nsf_wizard_tower_library_two_long_a_01"
			},
			sound_events = {
				[1] = "nsf_wizard_tower_library_two_long_a_01"
			},
		...
		nsf_wizard_tower_library_two_long_b = {
			...
			localization_strings = {
				[1] = "nsf_wizard_tower_library_two_long_a_02"
			},
			sound_events = {
				[1] = "nsf_wizard_tower_library_two_long_a_02"
			},
		...
		nsf_wizard_tower_library_two_long_c = {
			...
			localization_strings = {
				[1] = "nsf_wizard_tower_library_two_long_a_03"
			},
			sound_events = {
				[1] = "nsf_wizard_tower_library_two_long_a_03"
			},
