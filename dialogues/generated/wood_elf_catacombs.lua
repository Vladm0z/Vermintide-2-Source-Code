-- chunkname: @dialogues/generated/wood_elf_catacombs.lua
	...
	add_dialogues({
		pwe_catacombs_intro_a = {
			...
			localization_strings = {
				[1] = "pwe_catacombs_intro_a_01",
				[2] = "pwe_catacombs_intro_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwe_catacombs_intro_a_01",
		...
		pwe_catacombs_intro_b = {
			...
			localization_strings = {
				[1] = "pwe_catacombs_intro_b_01",
				[2] = "pwe_catacombs_intro_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwe_catacombs_intro_b_01",
		...
		pwe_catacombs_intro_c = {
			...
			localization_strings = {
				[1] = "pwe_catacombs_intro_c_01",
				[2] = "pwe_catacombs_intro_c_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pwe_catacombs_intro_c_01",
