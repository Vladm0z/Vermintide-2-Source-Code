-- chunkname: @dialogues/generated/dwarf_ranger_skittergate.lua
...
return function ()
	...
	add_dialogues({
		...
		pdr_level_skittergate_rasknitt_gate_reply = {
			...
			localization_strings = {
				[1] = "pdr_level_skittergate_rasknitt_gate_reply_01",
				[2] = "pdr_level_skittergate_rasknitt_gate_reply_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pdr_level_skittergate_rasknitt_gate_reply_01",
		...
		pdr_level_skittergate_rasknitt_stormfiend_dead = {
			...
			localization_strings = {
				[1] = "pdr_level_skittergate_rasknitt_stormfiend_dead_01",
				[2] = "pdr_level_skittergate_rasknitt_stormfiend_dead_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pdr_level_skittergate_rasknitt_stormfiend_dead_01",
		...
		pdr_skittergate_intro_a = {
			...
			localization_strings = {
				[1] = "pdr_skittergate_intro_a_01",
				[2] = "pdr_skittergate_intro_a_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pdr_skittergate_intro_a_01",
		...
		pdr_skittergate_intro_b = {
			...
			localization_strings = {
				[1] = "pdr_skittergate_intro_b_01",
				[2] = "pdr_skittergate_intro_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pdr_skittergate_intro_b_01",
		...
		pdr_skittergate_intro_c = {
			...
			localization_strings = {
				[1] = "pdr_skittergate_intro_c_01",
				[2] = "pdr_skittergate_intro_c_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pdr_skittergate_intro_c_01",
