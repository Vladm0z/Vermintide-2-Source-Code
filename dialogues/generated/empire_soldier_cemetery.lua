-- chunkname: @dialogues/generated/empire_soldier_cemetery.lua
...
return function ()
	...
	add_dialogues({
		...
		pes_cemetary_intro_b = {
			...
			localization_strings = {
				[1] = "pes_cemetary_intro_b_01",
				[2] = "pes_cemetary_intro_b_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pes_cemetary_intro_b_01",
		...
		pes_cemetary_intro_c = {
			...
			localization_strings = {
				[1] = "pes_cemetary_intro_c_01",
				[2] = "pes_cemetary_intro_c_02"
			},
			randomize_indexes = {},
			sound_events = {
				[1] = "pes_cemetary_intro_c_01",
