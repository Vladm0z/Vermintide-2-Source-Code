...
ERROR_CODES[BACKEND_PLAYFAB_ERRORS.ERR_PLAYFAB_ACHIEVEMENT_REWARD_CLAIMED] = "backend_err_achievement_reward_claim"
...
BACKEND_PLAYFAB_ERRORS.ERR_PLAYFAB_ACCOUNT_BANNED = 1002
ERROR_CODES[BACKEND_PLAYFAB_ERRORS.ERR_PLAYFAB_ACCOUNT_BANNED] = "backend_err_account_banned"
