...
WorldManager.init = function (arg_1_0)
	arg_1_0._worlds = {}
...
WorldManager.create_world = function (arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4, ...)
...
WorldManager.wwise_world = function (arg_3_0, arg_3_1)
	return arg_3_0._wwise_worlds[arg_3_1]
end

WorldManager.destroy_world = function (arg_4_0, arg_4_1)
...
WorldManager.render = function (arg_8_0)
	for iter_8_0, iter_8_1 in ipairs(arg_8_0._update_queue) do
		ScriptWorld.render(iter_8_1)
	end
end

WorldManager.enable_world = function (arg_9_0, arg_9_1, arg_9_2)
	if arg_9_2 then
...
WorldManager.destroy = function (arg_10_0)
	for iter_10_0, iter_10_1 in pairs(arg_10_0._worlds) do
		arg_10_0:destroy_world(iter_10_0)
	end
end

WorldManager._sort_update_queue = function (arg_11_0)
